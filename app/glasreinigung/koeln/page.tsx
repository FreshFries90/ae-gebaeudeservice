...
export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Köln | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Köln: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/koeln" },
};

const cityAreas = "Kölner Innenstadt, Ehrenfeld, Deutz, Lindenthal und Gewerbeobjekte entlang der Ringe";
const localFocus = "Glasfronten an Ladenlokalen, Büroflächen in Deutz, Praxen in Lindenthal und stark frequentierte Eingänge rund um Innenstadt und Ehrenfeld";
const cityIntro = "In Köln wirken Glasflächen oft besonders schnell beansprucht: Verkehr, Baustellenstaub, Regenstreifen und viel Publikumsverkehr hinterlassen an Schaufenstern, Eingangsfronten und Bürogebäuden sichtbare Spuren. Wir planen die Glas- und Fassadenreinigung so, dass sie zum Objekt, zum Standort und zu den Öffnungszeiten passt.";
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 items-center w-full min-w-0">
            <div className="lg:col-span-7 min-w-0">
              <div className="inline-block max-w-full break-words bg-primary text-white font-bold px-3 sm:px-4 py-1 mb-6 md:mb-8 -rotate-1 shadow-lg uppercase tracking-wider text-xs sm:text-sm">
                Glasreinigung & Fassadenreinigung in {CITY}
              </div>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-2xl border-l-4 border-primary pl-4 md:pl-6 py-2 break-words">
                Streifenfreie Glasreinigung und gepflegte Fassadenflächen für {cityAreas}. Wir reinigen Fenster, Glasfronten, Eingänge und sichtbare Außenflächen zuverlässig, damit Ihr Objekt in {CITY} sauber und professionell wirkt.
              </p>
            ...
            <div className="lg:col-span-5 hidden lg:block min-w-0">
              <div className="relative w-full max-w-lg aspect-square mask-blob shadow-2xl bg-gray-800 mx-auto overflow-hidden">
                <Image
                  alt={`Glas- und Fassadenreinigung in ${CITY}`}
        ...
        <div className="w-full bg-white py-8 sm:py-10 relative z-20 border-t-4 border-primary mt-8 md:mt-12">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10 md:gap-24 grayscale opacity-70 hover:grayscale-0 transition-all text-center">
              {[
                ["window", "Streifenfreie Glasreinigung"],
                ["apartment", "Saubere Fassadenflächen"],
                ["visibility", "Gepflegter Gesamteindruck"],
                ["schedule", "Flexible Intervalle"],
              ].map(([icon, label]) => (
                <div className="flex items-center gap-2 min-w-0" key={label}>
                  <span className="material-icons-outlined text-2xl sm:text-3xl text-primary shrink-0">{icon}</span>
                  <span className="font-black text-base sm:text-lg md:text-xl tracking-tighter uppercase italic break-words">{label}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="bg-primary py-6 md:py-8 overflow-hidden relative border-y-4 border-black">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 min-w-0">
          <div className="flex items-center gap-4 md:gap-6 min-w-0">
            <span className="material-icons-outlined text-white text-4xl sm:text-5xl md:text-6xl shrink-0">window</span>
            <div className="min-w-0">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-white uppercase italic leading-none break-words">
                Glas oder Fassade in {CITY} reinigen?
              </h2>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mb-12 md:mb-16">
            <h2 className="text-primary font-bold tracking-widest uppercase text-xs sm:text-sm mb-3 break-words">
              Glasreinigung und Fassadenreinigung in {CITY}
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-gray-50 border-l-8 border-primary p-6 sm:p-8 md:p-10">
              <span className="material-icons-outlined text-primary text-4xl md:text-5xl mb-6 block">window</span>
              <h4 className="text-2xl sm:text-3xl font-black uppercase mb-4 break-words">Glasflächen reinigen</h4>
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed break-words">
                Fenster, Glaselemente, Eingangsbereiche und größere Glasfronten werden gründlich gereinigt. Besonders bei {localFocus} zahlt sich ein sauberer, heller und gepflegter Eindruck sofort aus.
              </p>
            </div>

            <div className="bg-primary text-white p-6 sm:p-8 md:p-10">
              <span className="material-icons-outlined text-white text-4xl md:text-5xl mb-6 block">domain</span>
              <h4 className="text-2xl sm:text-3xl font-black uppercase mb-4 break-words">Fassade auffrischen</h4>
              <p className="text-white/80 text-base sm:text-lg leading-relaxed break-words">
                Witterungsspuren, Ablagerungen und sichtbare Verschmutzungen an Außenflächen lassen ein Objekt schnell älter wirken. Wir reinigen Fassadenbereiche sauber und passend zur Immobilie in {CITY}.
              </p>
            </div>

            <div className="bg-black text-white p-6 sm:p-8 md:p-10">
              <span className="material-icons-outlined text-primary text-4xl md:text-5xl mb-6 block">high_quality</span>
              <h4 className="text-2xl sm:text-3xl font-black uppercase mb-4 break-words">Auch bei anspruchsvollen Flächen</h4>
              <p className="text-gray-400 text-base sm:text-lg leading-relaxed break-words">
                Ob großflächige Verglasung, schwer zugängliche Bereiche oder höhere Fassadenabschnitte: Der Einsatz wird vorab abgestimmt und zuverlässig umgesetzt.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-start">
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 uppercase mb-6 break-words">
                Was bei Glas- und Fassadenreinigung in {CITY} wichtig ist
              </h2>
              <div className="space-y-5 text-gray-700 text-base sm:text-lg leading-relaxed">
                <p className="break-words">
                  Glas und Fassadenflächen werden täglich gesehen. Genau deshalb fallen Verschmutzungen dort besonders schnell auf. Schlieren, Staub, Regenrückstände, Ablagerungen oder stumpf wirkende Flächen können das ganze Objekt ungepflegt erscheinen lassen, obwohl innen alles ordentlich ist.
                </p>
                <p className="break-words">
                  In {CITY} kommt es auf eine Reinigung an, die zum Standort passt: {localFocus} benötigen oft andere Abläufe als ein kleines Büro, eine Praxis oder ein Mehrparteienobjekt. Wir stimmen Termin, Umfang und Zugänglichkeit vorher sauber ab.
                </p>
                <p className="break-words">
                  Ob einmalige Reinigung, regelmäßiger Turnus oder Auffrischung vor einem wichtigen Termin – wir schauen uns an, was sinnvoll ist und setzen es zuverlässig um.
                </p>
              </div>
            </div>

            <div className="bg-white p-6 sm:p-8 md:p-10 shadow-xl border-t-4 border-primary">
              <h3 className="text-2xl sm:text-3xl font-black uppercase mb-6 break-words">Typische Einsatzbereiche</h3>
              <ul className="space-y-4 text-gray-700 text-base sm:text-lg">
                {[
                  `Bürogebäude und Gewerbeimmobilien in ${CITY}`,
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-5xl">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 uppercase mb-10 break-words">
              Für wen sich Glas- und Fassadenreinigung in {CITY} besonders lohnt
            </h2>

            <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
              <div className="bg-gray-50 p-6 sm:p-8 border-l-4 border-primary">
                <h3 className="text-xl sm:text-2xl font-black uppercase mb-4 break-words">Für Unternehmen mit Kundenkontakt</h3>
                <p className="text-gray-700 leading-relaxed break-words">Saubere Glasflächen und ein gepflegter Eingangsbereich wirken professionell und ordentlich. Gerade dort, wo Kunden, Besucher oder Geschäftspartner ein- und ausgehen, macht das sofort einen Unterschied.</p>
              </div>
              <div className="bg-gray-50 p-6 sm:p-8 border-l-4 border-primary">
                <h3 className="text-xl sm:text-2xl font-black uppercase mb-4 break-words">Für Büros und Verwaltungsgebäude</h3>
                <p className="text-gray-700 leading-relaxed break-words">Große Fensterflächen und Fassaden prägen das Gesamtbild eines Gebäudes. Regelmäßige Reinigung hilft dabei, den gepflegten Eindruck dauerhaft zu erhalten.</p>
              </div>
              <div className="bg-gray-50 p-6 sm:p-8 border-l-4 border-primary">
                <h3 className="text-xl sm:text-2xl font-black uppercase mb-4 break-words">Für Praxen und sensible Objekte</h3>
                <p className="text-gray-700 leading-relaxed break-words">In Bereichen, in denen Sauberkeit besonders schnell auffällt, sorgen gereinigte Glas- und Fassadenflächen für einen ruhigen, ordentlichen und vertrauenswürdigen Eindruck.</p>
              </div>
              <div className="bg-gray-50 p-6 sm:p-8 border-l-4 border-primary">
                <h3 className="text-xl sm:text-2xl font-black uppercase mb-4 break-words">Für Immobilien mit sichtbaren Witterungsspuren</h3>
                <p className="text-gray-700 leading-relaxed break-words">Gerade Außenflächen verlieren mit der Zeit schnell an Wirkung. Eine gezielte Reinigung kann das Erscheinungsbild spürbar verbessern, ohne dass direkt größere Maßnahmen nötig sind.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-gray-900 overflow-hidden relative">
        <div className="container mx-auto px-4 text-center min-w-0">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white uppercase mb-6 md:mb-8 break-words">
            Noch Fragen zum Ablauf in {CITY}?
          </h2>
          <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-10 md:mb-12 break-words">
            Rufen Sie uns einfach an. Oft lässt sich direkt klären, welche Flächen gereinigt werden sollen und welcher Termin sinnvoll ist.
          </p>
          ...
          <div className="inline-block max-w-full p-1 bg-gradient-to-r from-primary to-primary-accent rounded-2xl shadow-[0_0_50px_rgba(22,163,74,0.3)] w-full sm:w-auto">
            <div className="bg-black px-4 sm:px-10 md:px-12 py-8 sm:py-10 rounded-xl">
              <p className="text-primary font-black uppercase tracking-[0.3em] mb-4 text-xs sm:text-sm break-words">Rufen Sie uns direkt an</p>
              <a
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-start lg:items-center min-w-0">
            <div className="text-white min-w-0">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-md italic break-words">
                Ein kurzer Anruf spart oft viel Abstimmung. Wir sagen Ihnen direkt, was für Ihr Objekt in {CITY} sinnvoll ist und wie der Einsatz ablaufen kann.
              </p>
              ...
              <div className="p-6 sm:p-8 md:p-10 bg-primary shadow-[10px_10px_0px_#000000] md:shadow-[15px_15px_0px_#000000] max-w-full overflow-hidden">
                <p className="font-black text-black uppercase tracking-widest mb-4 text-sm break-words">Persönliche Beratung</p>
                <a

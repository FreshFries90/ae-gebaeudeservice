...
export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Aachen | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Aachen: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/aachen" },
};

const cityAreas = "Aachener Praxen, Kanzleien, Büros, Ladenlokale und Immobilien mit Publikumsverkehr";
const localFocus = "Fensterflächen in Innenstadt, Burtscheid, Brand, Laurensberg und bei gewerblichen Objekten";
const cityIntro = "In Aachen treffen historische Gebäudestrukturen, moderne Büroflächen und stark frequentierte Innenstadtlagen aufeinander. Glas- und Fassadenflächen benötigen daher eine Reinigung, die sorgfältig geplant und sauber umgesetzt wird. Wir sorgen für klare Sicht und gepflegte Außenwirkung.";

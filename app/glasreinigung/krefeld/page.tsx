...
export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Krefeld | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Krefeld: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/krefeld" },
};

const cityAreas = "Krefelder Gewerbeimmobilien, Praxen, Büros, Ladenlokale und Objektverwaltungen";
const localFocus = "Schaufenster, Eingangsbereiche, Bürofenster und Fassaden in Innenstadt, Bockum, Uerdingen und Gewerbelagen";
const cityIntro = "Krefeld bietet viele Ladenlokale, Büroflächen und gewerbliche Objekte, bei denen der äußere Eindruck zählt. Wir reinigen Glasflächen, Fenster und Fassadenbereiche zuverlässig, damit Verschmutzungen, Regenstreifen und Ablagerungen nicht den Gesamteindruck bestimmen.";

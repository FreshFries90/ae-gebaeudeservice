...
export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Düsseldorf | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Düsseldorf: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/duesseldorf" },
};

const cityAreas = "Düsseldorfer Büros, Kanzleien, Praxen, Showrooms und Immobilienstandorte";
const localFocus = "repräsentative Glasfassaden in der Innenstadt, Schaufenster rund um Einkaufsstraßen und Büroobjekte in Hafen, Pempelfort und Oberkassel";
const cityIntro = "In Düsseldorf zählt der erste Eindruck besonders: Kanzleien, Showrooms, Praxen, hochwertige Büroflächen und Ladenlokale profitieren sichtbar von sauberen Glasflächen und gepflegten Fassaden. Wir reinigen zuverlässig, diskret und mit einem Ablauf, der auch bei laufendem Betrieb funktioniert.";

...
export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Wuppertal | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Wuppertal: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/wuppertal" },
};

const cityAreas = "Wuppertaler Gewerbeobjekte, Büros, Praxen und Immobilien an Hanglagen";
const localFocus = "Fensterfronten, Glasflächen, Eingänge und Fassadenbereiche in Elberfeld, Barmen und weiteren Stadtteilen";
const cityIntro = "In Wuppertal sind Gebäude oft unterschiedlich geschnitten, liegen an Steigungen oder haben schwerer zugängliche Bereiche. Gerade deshalb ist eine saubere Planung wichtig. Wir stimmen die Glas- und Fassadenreinigung objektbezogen ab und reinigen sichtbare Flächen gründlich und zuverlässig.";

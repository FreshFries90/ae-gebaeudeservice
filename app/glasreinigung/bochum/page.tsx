...
export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Bochum | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Bochum: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/bochum" },
};

const cityAreas = "Bochumer Büros, Praxen, Einzelhandel, Hausverwaltungen und Gewerbeobjekte";
const localFocus = "Glasflächen in der Innenstadt, am Bermuda3Eck, bei Praxen, Gewerbeflächen und Eingangsbereichen";
const cityIntro = "Bochum hat viele Objekte mit täglichem Kunden- und Besucherverkehr. Schaufenster, Eingänge, Bürofenster und Fassadenbereiche prägen dabei sofort den Eindruck. Wir reinigen diese Flächen zuverlässig und sorgen dafür, dass Immobilien und Gewerbeflächen gepflegt auftreten.";

...
export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Duisburg | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Duisburg: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/duisburg" },
};

const cityAreas = "Duisburger Gewerbeflächen, Industrieumfeld, Büros und Immobilienbestände";
const localFocus = "Fenster und Fassaden an Bürotrakten, Eingangsbereichen, Werkstätten, Verwaltungsflächen und Ladenlokalen";
const cityIntro = "In Duisburg treffen Industrie, Logistik, Handel und Wohnimmobilien aufeinander. Glasflächen sind hier häufig durch Staub, Verkehr und Witterung belastet. Unsere Glas- und Fassadenreinigung ist auf robuste, sichtbare Ergebnisse ausgelegt: sauber, planbar und passend zum Objekt.";

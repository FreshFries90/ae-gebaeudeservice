...
export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Gelsenkirchen | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Gelsenkirchen: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/gelsenkirchen" },
};

const cityAreas = "Gelsenkirchener Gewerbe, Büros, Praxen, Ladenlokale und Immobilienverwaltungen";
const localFocus = "Fensterflächen, Eingangsbereiche und Fassaden in Buer, Altstadt, Schalke und Gewerbelagen";
const cityIntro = "In Gelsenkirchen sind viele Objekte täglich Staub, Verkehr und Wetter ausgesetzt. Gerade bei Ladenlokalen, Praxen, Büros und Mehrparteienobjekten lohnt sich eine sichtbare Auffrischung. Wir reinigen Glas und Fassade gründlich und unkompliziert.";

...
export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Bonn | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Bonn: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/bonn" },
};

const cityAreas = "Bonner Büros, Kanzleien, Praxen, Institutionen und gepflegte Immobilien";
const localFocus = "Glasflächen in der Innenstadt, Südstadt, Bad Godesberg, Beuel und an repräsentativen Bürostandorten";
const cityIntro = "Bonn steht für viele repräsentative Immobilien, Kanzleien, Praxen, Büroflächen und Einrichtungen mit regelmäßigem Besucherverkehr. Saubere Glasflächen und Fassaden unterstützen hier einen seriösen Eindruck. Wir reinigen zuverlässig, ordentlich und passend zu sensiblen Objektabläufen.";

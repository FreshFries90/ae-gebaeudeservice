...
const CITY = "Mönchengladbach";

export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Mönchengladbach | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Mönchengladbach: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/moenchengladbach" },
};

const cityAreas = "Mönchengladbacher Büros, Praxen, Einzelhandel, Gewerbe und Immobilienbestände";
const localFocus = "Glasflächen und Fassaden in Gladbach, Rheydt, Wickrath und gewerblichen Bereichen";
const cityIntro = "Mönchengladbach hat viele gemischt genutzte Immobilien, Ladenflächen und Gewerbestandorte. Saubere Fenster, Eingänge und Fassadenbereiche verbessern hier schnell den Gesamteindruck. Wir stimmen Umfang und Rhythmus passend zum Objekt ab.";

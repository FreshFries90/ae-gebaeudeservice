...
export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Dortmund | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Dortmund: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/dortmund" },
};

const cityAreas = "Dortmunder Gewerbe, Büros, Praxen, Ladenlokale und Immobilienverwaltungen";
const localFocus = "Glasflächen in der City, Bürogebäude am Wall, Gewerbeobjekte und Eingangsbereiche mit viel Laufkundschaft";
const cityIntro = "Dortmund verbindet Innenstadtlagen, große Bürostandorte, Gewerbeparks und viele stark genutzte Immobilien. Genau dort fallen verschmutzte Fenster, matte Glasfronten und Witterungsspuren schnell auf. Wir sorgen für klare Sicht und einen gepflegten Eindruck ohne komplizierte Abstimmung.";

...
export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Essen | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Essen: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/essen" },
};

const cityAreas = "Essener Bürohäuser, Praxen, Wohn- und Gewerbeimmobilien";
const localFocus = "Objekte in Rüttenscheid, Innenstadt, Südviertel, Steele und gewerblich genutzte Flächen mit sichtbaren Fassaden";
const cityIntro = "In Essen gibt es viele Immobilien, bei denen Glas und Fassade direkt den Gesamteindruck bestimmen: Bürohäuser, Praxen, Ladenflächen und Mehrparteienobjekte. Wir reinigen Glasflächen, Eingänge und Fassadenbereiche gründlich, damit das Objekt wieder ordentlich, hell und gepflegt wirkt.";

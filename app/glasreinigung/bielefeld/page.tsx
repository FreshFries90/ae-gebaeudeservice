...
export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Bielefeld | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Bielefeld: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/bielefeld" },
};

const cityAreas = "Bielefelder Bürogebäude, Praxen, Ladenflächen und Gewerbeimmobilien";
const localFocus = "Fenster, Eingangsbereiche und Fassaden in Innenstadt, Schildesche, Brackwede und gewerblichen Lagen";
const cityIntro = "In Bielefeld profitieren besonders Praxen, Büros, Ladenlokale und gepflegte Gewerbeimmobilien von regelmäßiger Glas- und Fassadenreinigung. Wir entfernen Verschmutzungen, Schlieren und Witterungsspuren, damit der Auftritt nach außen wieder klar und professionell wirkt.";

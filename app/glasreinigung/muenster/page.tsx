...
export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Münster | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Münster: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/muenster" },
};

const cityAreas = "Münsteraner Praxen, Büros, Ladenlokale, Verwaltungen und gepflegte Immobilien";
const localFocus = "Schaufenster, Fensterflächen, Eingänge und Fassaden in Innenstadt, Hafen, Geist und weiteren Stadtteilen";
const cityIntro = "Münster hat viele gepflegte Geschäftslagen, Praxen und Büroflächen, bei denen Glasflächen stark zum Erscheinungsbild beitragen. Wir sorgen für streifenfreie Fenster, saubere Eingangsfronten und gepflegte Fassadenbereiche – ideal für Objekte mit hohem Anspruch an Wirkung und Ordnung.";

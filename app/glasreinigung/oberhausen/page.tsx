...
export const metadata: Metadata = {
  title: "Glas- & Fassadenreinigung in Oberhausen | AE Gebäudeservice",
  description:
    "Glasreinigung und Fassadenreinigung in Oberhausen: Fenster, Glasfronten, Eingänge und Fassaden für Gewerbe, Büro, Praxis und Immobilien. Jetzt Termin sichern.",
  alternates: { canonical: "/glasreinigung/oberhausen" },
};

const cityAreas = "Oberhausener Gewerbe, Einzelhandel, Praxen, Büros und Immobilienverwaltungen";
const localFocus = "Glasflächen am Centro-Umfeld, in Alt-Oberhausen, Sterkrade, Osterfeld und gewerblich genutzten Objekten";
const cityIntro = "In Oberhausen sind viele Glasflächen durch Publikumsverkehr, Verkehrsnähe und Witterung sichtbar beansprucht. Für Ladenlokale, Büros, Praxen und Immobilienverwaltungen reinigen wir Fenster, Eingangsbereiche und Fassadenflächen gründlich und planbar.";

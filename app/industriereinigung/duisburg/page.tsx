// app/industriereinigung/duisburg/page.tsx
...
export const metadata: Metadata = {
  title: "Industriereinigung in Duisburg | AE Gebäudeservice",
  description:
    "Industriereinigung in Duisburg für Maschinen, Werkshallen, Produktionsflächen und stark beanspruchte Betriebsbereiche. Jetzt AE Gebäudeservice direkt anrufen.",
};

export default function IndustriereinigungDuisburgPage() {
  return (
    <>
      <a
      ...
      <section className="relative overflow-hidden bg-black text-white">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Industriereinigung in Duisburg"
            fill
            priority
        ...
        <div className="container relative z-10 mx-auto px-4 py-20 md:px-6 md:py-28 lg:py-36">
          <div className="max-w-4xl">
            <div className="mb-6 inline-block -rotate-1 bg-primary px-4 py-2 text-xs font-bold uppercase tracking-wider text-white shadow-lg sm:text-sm">
              Industriereinigung in Duisburg
            </div>
            ...
            <p className="mb-8 max-w-3xl border-l-4 border-primary pl-4 text-lg text-gray-300 sm:text-xl md:mb-10 md:pl-6 md:text-2xl">
              AE Gebäudeservice übernimmt Industriereinigung in Duisburg für Hafenlogistik, Industriehallen und belastete Verkehrsflächen. Wir reinigen Maschinenumfelder, Werkshallen, Laufwege und stark beanspruchte Betriebsbereiche zuverlässig, gründlich und direkt abstimmbar.
            </p>
        ...
        <div className="container mx-auto grid gap-10 px-4 md:px-6 lg:grid-cols-2 lg:items-center">
          <div className="relative min-h-[320px] overflow-hidden shadow-2xl md:min-h-[520px]">
            <Image
              ...
              alt="Industriereinigung auf Betriebsfläche in Duisburg"
              fill
          ...
          <div>
            <h2 className="mb-3 text-sm font-bold uppercase tracking-widest text-primary">
              Reinigung für Industrie und Gewerbe in Duisburg
            </h2>
            ...
            <div className="space-y-5 text-lg leading-relaxed text-gray-700">
              <p>In Duisburg treffen moderne Gewerbeflächen, klassische Produktionsbetriebe und stark genutzte Betriebsbereiche oft direkt aufeinander. Besonders in Bereichen wie Ruhrort, Kaßlerfeld, Rheinhausen, Meiderich und rund um Hafen- und Logistikflächen entstehen täglich Verschmutzungen durch Staub, Materialbewegung, Abrieb, Verpackungen, Maschinenumfelder oder laufende Prozesse.</p>
              <p>Unsere Industriereinigung in Duisburg ist deshalb auf praktische Abläufe ausgelegt. Wir schauen nicht nur auf sichtbare Sauberkeit, sondern auf nutzbare Flächen, freie Laufwege, ordentliche Arbeitszonen und einen Zustand, der zum jeweiligen Betrieb passt.</p>
              <p>Ob einmaliger Einsatz, regelmäßige Reinigung oder kurzfristige Unterstützung vor einer Begehung, Übergabe oder internen Kontrolle: Wir stimmen den Umfang direkt mit dir ab und setzen die Reinigung so um, dass dein Betrieb in Duisburg möglichst wenig gestört wird.</p>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-12 max-w-3xl">
            ...
            <p className="text-lg leading-relaxed text-gray-700">
              Wir unterstützen Unternehmen in Duisburg überall dort, wo herkömmliche Reinigung an ihre Grenzen stößt: an Maschinen, auf Hallenflächen, in produktionsnahen Bereichen und auf stark beanspruchten Betriebsflächen.
            </p>
          </div>
      ...
      <section className="bg-gray-50 py-16 md:py-24">
        <div className="container mx-auto grid gap-10 px-4 md:px-6 lg:grid-cols-2 lg:items-center">
          <div>
            <h2 className="mb-3 text-sm font-bold uppercase tracking-widest text-primary">
              Warum AE Gebäudeservice in Duisburg
            </h2>
            <h3 className="mb-6 text-4xl font-black uppercase tracking-tight text-gray-900 md:text-6xl">
            ...
            <div className="space-y-5 text-lg leading-relaxed text-gray-700">
              <p>Für Industrie- und Gewerbekunden in Duisburg zählt vor allem Verlässlichkeit. Termine müssen eingehalten werden, Betriebsabläufe dürfen nicht unnötig blockiert werden und das Ergebnis muss sichtbar sein. Genau darauf richten wir die Planung aus.</p>
              <p>
              ...
              <p>
                Ob Werkshalle, Produktionsumgebung oder Maschinenumfeld: Wenn du in Duisburg eine Industriereinigung suchst, die erreichbar, gründlich und unkompliziert ist, kannst du uns direkt anrufen und den Einsatz besprechen.
              </p>
            </div>
          </div>
          ...
          <div className="relative min-h-[320px] overflow-hidden shadow-2xl md:min-h-[520px]">
            <Image
              ...
              alt="Saubere Industriehalle nach Reinigung in Duisburg"
              fill
              className="object-cover"
            />
        ...
        <div className="container mx-auto flex flex-col items-center justify-between gap-6 px-4 text-center md:px-6 lg:flex-row lg:text-left">
          <div>
            <h2 className="text-3xl font-black uppercase italic leading-none text-white md:text-5xl">
              Industriereinigung in Duisburg direkt anfragen
            </h2>

...
export const metadata: Metadata = {
  title: "Gebäudereinigung Krefeld | AE Gebäudeservice",
  description:
    "Professionelle Gebäudereinigung in Krefeld für Büro, Gewerbe, Treppenhaus, Praxis und Objektpflege. Schnell, gründlich und zuverlässig. Jetzt anrufen.",
  alternates: {
    canonical: "/gebaeudereinigung/krefeld",
  },
};

export default function GebaeudereinigungKrefeldPage() {
  return (
    <>
      <a
      ...
      <section className="relative overflow-hidden bg-background-dark text-white">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Professionelle Gebäudereinigung in Krefeld"
            fill
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 py-20 md:py-28 lg:py-36">
          <div className="max-w-4xl">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-3xl border-l-4 border-primary pl-4 md:pl-6 py-2 mb-8 md:mb-10">
              AE Gebäudeservice übernimmt Gebäudereinigung in Krefeld für
              Gewerbeobjekte, Büros, Praxen, Treppenhäuser, Ladenflächen und
              Produktionsnähe. Wir sorgen für gepflegte Eingangsbereiche, saubere
        ...
        <div className="container mx-auto px-4 md:px-6 py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="font-black uppercase">Vor Ort in Krefeld</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div className="relative min-h-[320px] md:min-h-[500px] overflow-hidden shadow-2xl">
            <Image
              ...
              alt="Reinigungskraft bei der Gebäudereinigung in Krefeld"
              title="Reinigungskraft bei der Gebäudereinigung in Krefeld"
              fill
          ...
          <div>
            <h2 className="text-primary font-bold tracking-widest uppercase text-sm mb-3">
              Sauberkeit mit System in Krefeld
            </h2>
            ...
            <div className="space-y-5 text-lg text-text-muted leading-relaxed">
              <p>
                Krefeld ist stark durch Gewerbe, Handel, Dienstleistungen und gewachsene
                Immobilienstrukturen geprägt. Gebäudereinigung muss hier zuverlässig
                funktionieren und sich an unterschiedliche Objektarten anpassen.
              </p>

              <p>
                In Krefeld sind saubere Eingänge, ordentliche Sanitärbereiche und
                gepflegte Arbeitsflächen wichtig, damit Gewerbe- und Wohnobjekte dauerhaft
                professionell wirken.
              </p>

              <p>
                Wir reinigen in Krefeld unter anderem rund um Stadtmitte, Uerdingen,
                Fischeln, Oppum, Hüls und Bockum. Ob regelmäßige Unterhaltsreinigung,
            ...
            >
              ...
              Gebäudereinigung in Krefeld anfragen
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white" id="leistungen">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mb-12">
            <h2 className="text-primary font-bold tracking-widest uppercase text-sm mb-3">
              Leistungen in Krefeld
            </h2>
            <h3 className="text-4xl md:text-6xl font-black uppercase tracking-tight text-gray-900 mb-6">
              Gebäudereinigung für Büro, Gewerbe und Objekt
            </h3>
            <p className="text-lg text-text-muted leading-relaxed">
              Von der Büroreinigung bis zur Treppenhausreinigung: In Krefeld übernehmen
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: "apartment",
                title: "Büroreinigung in Krefeld",
      ...
      <section className="py-16 md:py-24 bg-background-light">
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="space-y-5 text-lg text-text-muted leading-relaxed">
              <p>
                Viele Unternehmen und Hausverwaltungen in Krefeld suchen nicht irgendeine
              ...
              <p>
                ...
                in Krefeld mit unterschiedlichen Objektarten ist es wichtig, dass
          ...
          <div className="relative min-h-[320px] md:min-h-[500px] overflow-hidden shadow-2xl">
            <Image
              ...
              alt="Sauberes Objekt nach Gebäudereinigung in Krefeld"
              title="Sauberes Objekt nach Gebäudereinigung in Krefeld"
              fill
              className="object-cover"
            />
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-start lg:items-center min-w-0">
            <div className="text-white min-w-0">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-md italic break-words">
                Du suchst Gebäudereinigung in Krefeld? Ein kurzer Anruf reicht oft, um
      ...
      <section className="py-16 md:py-24 bg-black text-white">
        <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl">
          ...
          <p className="text-lg md:text-2xl text-gray-300 leading-relaxed mb-10">
            ...
            Treppenhausreinigung oder gewerbliche Reinigung in Krefeld? Dann ruf jetzt

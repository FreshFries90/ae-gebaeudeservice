...
export const metadata: Metadata = {
  title: "Gebäudereinigung Bielefeld | AE Gebäudeservice",
  description:
    "Professionelle Gebäudereinigung in Bielefeld für Büro, Gewerbe, Treppenhaus, Praxis und Objektpflege. Schnell, gründlich und zuverlässig. Jetzt anrufen.",
  alternates: {
    canonical: "/gebaeudereinigung/bielefeld",
  },
};

export default function GebaeudereinigungBielefeldPage() {
  return (
    <>
      <a
      ...
      <section className="relative overflow-hidden bg-background-dark text-white">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Professionelle Gebäudereinigung in Bielefeld"
            fill
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 py-20 md:py-28 lg:py-36">
          <div className="max-w-4xl">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-3xl border-l-4 border-primary pl-4 md:pl-6 py-2 mb-8 md:mb-10">
              AE Gebäudeservice übernimmt Gebäudereinigung in Bielefeld für Büros,
              Praxen, Verwaltungsflächen, Treppenhäuser und Gewerbeimmobilien. Wir
        ...
        <div className="container mx-auto px-4 md:px-6 py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="font-black uppercase">Vor Ort in Bielefeld</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div className="relative min-h-[320px] md:min-h-[500px] overflow-hidden shadow-2xl">
            <Image
              ...
              alt="Reinigungskraft bei der Gebäudereinigung in Bielefeld"
              title="Reinigungskraft bei der Gebäudereinigung in Bielefeld"
              fill
          ...
          <div>
            <h2 className="text-primary font-bold tracking-widest uppercase text-sm mb-3">
              Sauberkeit mit System in Bielefeld
            </h2>
            ...
            <div className="space-y-5 text-lg text-text-muted leading-relaxed">
              <p>
                Bielefeld kombiniert Mittelstand, Dienstleistung, medizinische
                Einrichtungen und Wohnobjekte. Für viele Immobilien zählt eine
                Gebäudereinigung, die zuverlässig, seriös und ohne unnötigen
                Abstimmungsaufwand funktioniert.
              </p>

              <p>
                In Bielefeld ist eine klare, regelmäßige und gründliche Reinigung gefragt
                – passend für Unternehmen, Hausverwaltungen und Einrichtungen mit
                dauerhaftem Anspruch an Sauberkeit.
              </p>

              <p>
                Wir reinigen in Bielefeld unter anderem rund um Mitte, Schildesche,
                Brackwede, Heepen, Jöllenbeck und Sennestadt. Ob regelmäßige
            ...
            >
              ...
              Gebäudereinigung in Bielefeld anfragen
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white" id="leistungen">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mb-12">
            <h2 className="text-primary font-bold tracking-widest uppercase text-sm mb-3">
              Leistungen in Bielefeld
            </h2>
            <h3 className="text-4xl md:text-6xl font-black uppercase tracking-tight text-gray-900 mb-6">
              Gebäudereinigung für Büro, Gewerbe und Objekt
            </h3>
            <p className="text-lg text-text-muted leading-relaxed">
              Von der Büroreinigung bis zur Treppenhausreinigung: In Bielefeld
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: "apartment",
                title: "Büroreinigung in Bielefeld",
        ...
        <div className="container mx-auto px-4 md:px-6 flex flex-col lg:flex-row gap-6 items-center justify-between">
          <div>
            <h2 className="text-3xl md:text-5xl font-black uppercase italic text-white leading-none">
              Reinigung in Bielefeld anfragen
            </h2>
      ...
      <section className="py-16 md:py-24 bg-background-light">
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="space-y-5 text-lg text-text-muted leading-relaxed">
              <p>
                Viele Unternehmen und Hausverwaltungen in Bielefeld suchen nicht
              ...
              <p>
                ...
                in Bielefeld mit unterschiedlichen Objektarten ist es wichtig, dass
          ...
          <div className="relative min-h-[320px] md:min-h-[500px] overflow-hidden shadow-2xl">
            <Image
              ...
              alt="Sauberes Objekt nach Gebäudereinigung in Bielefeld"
              title="Sauberes Objekt nach Gebäudereinigung in Bielefeld"
              fill
              className="object-cover"
            />
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-start lg:items-center min-w-0">
            <div className="text-white min-w-0">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-md italic break-words">
                Du suchst Gebäudereinigung in Bielefeld? Ein kurzer Anruf reicht oft, um
      ...
      <section className="py-16 md:py-24 bg-black text-white">
        <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl">
          ...
          <p className="text-lg md:text-2xl text-gray-300 leading-relaxed mb-10">
            ...
            Treppenhausreinigung oder gewerbliche Reinigung in Bielefeld? Dann ruf

...
export const metadata: Metadata = {
  title: "Gebäudereinigung Gelsenkirchen | AE Gebäudeservice",
  description:
    "Professionelle Gebäudereinigung in Gelsenkirchen für Büro, Gewerbe, Treppenhaus, Praxis und Objektpflege. Schnell, gründlich und zuverlässig. Jetzt anrufen.",
  alternates: {
    canonical: "/gebaeudereinigung/gelsenkirchen",
  },
};

export default function GebaeudereinigungGelsenkirchenPage() {
  return (
    <>
      <a
      ...
      <section className="relative overflow-hidden bg-background-dark text-white">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Professionelle Gebäudereinigung in Gelsenkirchen"
            fill
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 py-20 md:py-28 lg:py-36">
          <div className="max-w-4xl">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-3xl border-l-4 border-primary pl-4 md:pl-6 py-2 mb-8 md:mb-10">
              AE Gebäudeservice übernimmt Gebäudereinigung in Gelsenkirchen für
              Gewerbeflächen, Treppenhäuser, Büros, Praxen und stark genutzte
              Objektbereiche. Wir sorgen für gepflegte Eingangsbereiche, saubere
              Arbeitsflächen, hygienische Sanitärbereiche und einen professionellen
              Eindruck bei Kunden, Besuchern und Mitarbeitern.
            </p>
        ...
        <div className="container mx-auto px-4 md:px-6 py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="font-black uppercase">Vor Ort in Gelsenkirchen</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div className="relative min-h-[320px] md:min-h-[500px] overflow-hidden shadow-2xl">
            <Image
              ...
              alt="Reinigungskraft bei der Gebäudereinigung in Gelsenkirchen"
              title="Reinigungskraft bei der Gebäudereinigung in Gelsenkirchen"
              fill
          ...
          <div>
            <h2 className="text-primary font-bold tracking-widest uppercase text-sm mb-3">
              Sauberkeit mit System in Gelsenkirchen
            </h2>
            ...
            <div className="space-y-5 text-lg text-text-muted leading-relaxed">
              <p>
                Gelsenkirchen hat viele Wohn- und Gewerbeobjekte mit täglicher Nutzung.
                Treppenhäuser, Eingänge und Sanitärbereiche müssen hier zuverlässig
                gepflegt werden, damit Objekte dauerhaft ordentlich und nutzbar bleiben.
              </p>

              <p>
                Für Gelsenkirchen zählt Gebäudereinigung, die pragmatisch, gründlich und
                zuverlässig ist – besonders bei stark frequentierten Flächen und
                Hausverwaltungsobjekten.
              </p>

              <p>
                Wir reinigen in Gelsenkirchen unter anderem rund um Buer, Schalke, Erle,
                Horst, Ückendorf und die Innenstadt. Ob regelmäßige Unterhaltsreinigung,
                Treppenhausreinigung, Büroreinigung oder gezielte Objektpflege: Wir
                stimmen Umfang, Rhythmus und Schwerpunkte direkt mit dir ab.
              </p>
            </div>
            ...
            >
              ...
              Gebäudereinigung in Gelsenkirchen anfragen
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-lg text-text-muted leading-relaxed">
              Von der Büroreinigung bis zur Treppenhausreinigung: In Gelsenkirchen
              übernehmen wir die Reinigung so, dass sie zu Nutzung, Objektgröße,
              Öffnungszeiten und gewünschtem Qualitätsniveau passt.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: "apartment",
                title: "Büroreinigung in Gelsenkirchen",
        ...
        <div className="container mx-auto px-4 md:px-6 flex flex-col lg:flex-row gap-6 items-center justify-between">
          <div>
            <h2 className="text-3xl md:text-5xl font-black uppercase italic text-white leading-none">
              Reinigung in Gelsenkirchen anfragen
            </h2>
      ...
      <section className="py-16 md:py-24 bg-background-light">
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="space-y-5 text-lg text-text-muted leading-relaxed">
              <p>
                Viele Unternehmen und Hausverwaltungen in Gelsenkirchen suchen nicht
                irgendeine Reinigung, sondern einen Dienstleister, der erreichbar ist,
                mitdenkt und zuverlässig arbeitet. Genau darauf ist AE Gebäudeservice
                ausgelegt.
              </p>
              ...
              <p>
                ...
                in Gelsenkirchen mit unterschiedlichen Objektarten ist es wichtig, dass
                Reinigung flexibel bleibt und trotzdem zuverlässig ausgeführt wird.
              </p>
          ...
          <div className="relative min-h-[320px] md:min-h-[500px] overflow-hidden shadow-2xl">
            <Image
              ...
              alt="Sauberes Objekt nach Gebäudereinigung in Gelsenkirchen"
              title="Sauberes Objekt nach Gebäudereinigung in Gelsenkirchen"
              fill
              className="object-cover"
            />
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-start lg:items-center min-w-0">
            <div className="text-white min-w-0">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-md italic break-words">
                Du suchst Gebäudereinigung in Gelsenkirchen? Ein kurzer Anruf reicht oft,
                um Objektart, Umfang, Rhythmus und den nächsten freien Termin direkt
                abzustimmen.
              </p>
      ...
      <section className="py-16 md:py-24 bg-black text-white">
        <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl">
          ...
          <p className="text-lg md:text-2xl text-gray-300 leading-relaxed mb-10">
            ...
            Treppenhausreinigung oder gewerbliche Reinigung in Gelsenkirchen? Dann ruf
            jetzt an und besprich deinen Einsatz direkt mit uns.
          </p>

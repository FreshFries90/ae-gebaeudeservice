...
export default function GebaeudereinigungForm() {
        ...
        <div className="space-y-6 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <textarea
              ...
              name="message"
              placeholder="Zum Beispiel: Büro, Treppenhaus, Gewerbefläche, Sanitärbereiche, regelmäßige Reinigung, kurzfristiger Termin ..."
            />
          </div>
          ...
          >
            <span className="break-words">
              {status === "sending" ? "SENDET..." : "JETZT TERMIN SICHERN"}
            </span>

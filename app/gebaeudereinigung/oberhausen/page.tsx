...
export const metadata: Metadata = {
  title: "Gebäudereinigung Oberhausen | AE Gebäudeservice",
  description:
    "Professionelle Gebäudereinigung in Oberhausen für Büro, Gewerbe, Treppenhaus, Praxis und Objektpflege. Schnell, gründlich und zuverlässig. Jetzt anrufen.",
  alternates: {
    canonical: "/gebaeudereinigung/oberhausen",
  },
};

export default function GebaeudereinigungOberhausenPage() {
  return (
    <>
      <a
      ...
      <section className="relative overflow-hidden bg-background-dark text-white">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Professionelle Gebäudereinigung in Oberhausen"
            fill
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 py-20 md:py-28 lg:py-36">
          <div className="max-w-4xl">
            <div className="inline-block bg-primary text-white font-bold px-4 py-2 mb-6 -rotate-1 shadow-lg uppercase tracking-wider text-xs sm:text-sm">
              Gebäudereinigung in Oberhausen für Gewerbe, Objekt & Verwaltung
            </div>
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-3xl border-l-4 border-primary pl-4 md:pl-6 py-2 mb-8 md:mb-10">
              AE Gebäudeservice übernimmt Gebäudereinigung in Oberhausen für Büros,
              Einzelhandel, Gewerbeflächen, Treppenhäuser und Objektpflege. Wir sorgen
        ...
        <div className="container mx-auto px-4 md:px-6 py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="font-black uppercase">Vor Ort in Oberhausen</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div className="relative min-h-[320px] md:min-h-[500px] overflow-hidden shadow-2xl">
            <Image
              ...
              alt="Reinigungskraft bei der Gebäudereinigung in Oberhausen"
              title="Reinigungskraft bei der Gebäudereinigung in Oberhausen"
              fill
          ...
          <div>
            <h2 className="text-primary font-bold tracking-widest uppercase text-sm mb-3">
              Sauberkeit mit System in Oberhausen
            </h2>
            ...
            <div className="space-y-5 text-lg text-text-muted leading-relaxed">
              <p>
                Oberhausen hat stark genutzte Gewerbeflächen, Einzelhandel, Wohnobjekte
                und Objektbereiche mit viel Publikumsverkehr. Gerade dort müssen Eingänge,
                Laufwege und Sanitärflächen dauerhaft sauber bleiben.
              </p>

              <p>
                Für Oberhausen ist Gebäudereinigung gefragt, die unkompliziert erreichbar
                ist, schnell reagiert und auch bei stark genutzten Flächen zuverlässig
                saubere Ergebnisse liefert.
              </p>

              <p>
                Wir reinigen in Oberhausen unter anderem rund um Alt-Oberhausen,
                Sterkrade, Osterfeld, Neue Mitte, Alstaden und Holten. Ob regelmäßige
            ...
            >
              ...
              Gebäudereinigung in Oberhausen anfragen
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-lg text-text-muted leading-relaxed">
              Von der Büroreinigung bis zur Treppenhausreinigung: In Oberhausen
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: "apartment",
                title: "Büroreinigung in Oberhausen",
        ...
        <div className="container mx-auto px-4 md:px-6 flex flex-col lg:flex-row gap-6 items-center justify-between">
          <div>
            <h2 className="text-3xl md:text-5xl font-black uppercase italic text-white leading-none">
              Reinigung in Oberhausen anfragen
            </h2>
      ...
      <section className="py-16 md:py-24 bg-background-light">
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="space-y-5 text-lg text-text-muted leading-relaxed">
              <p>
                Viele Unternehmen und Hausverwaltungen in Oberhausen suchen nicht
              ...
              <p>
                ...
                in Oberhausen mit unterschiedlichen Objektarten ist es wichtig, dass
          ...
          <div className="relative min-h-[320px] md:min-h-[500px] overflow-hidden shadow-2xl">
            <Image
              ...
              alt="Sauberes Objekt nach Gebäudereinigung in Oberhausen"
              title="Sauberes Objekt nach Gebäudereinigung in Oberhausen"
              fill
              className="object-cover"
            />
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-start lg:items-center min-w-0">
            <div className="text-white min-w-0">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-md italic break-words">
                Du suchst Gebäudereinigung in Oberhausen? Ein kurzer Anruf reicht oft, um
      ...
      <section className="py-16 md:py-24 bg-black text-white">
        <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl">
          ...
          <p className="text-lg md:text-2xl text-gray-300 leading-relaxed mb-10">
            ...
            Treppenhausreinigung oder gewerbliche Reinigung in Oberhausen? Dann ruf

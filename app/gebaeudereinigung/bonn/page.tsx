...
export const metadata: Metadata = {
  title: "Gebäudereinigung Bonn | AE Gebäudeservice",
  description:
    "Professionelle Gebäudereinigung in Bonn für Büro, Gewerbe, Treppenhaus, Praxis und Objektpflege. Schnell, gründlich und zuverlässig. Jetzt anrufen.",
  alternates: {
    canonical: "/gebaeudereinigung/bonn",
  },
};

export default function GebaeudereinigungBonnPage() {
  return (
    <>
      <a
      ...
      <section className="relative overflow-hidden bg-background-dark text-white">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Professionelle Gebäudereinigung in Bonn"
            fill
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 py-20 md:py-28 lg:py-36">
          <div className="max-w-4xl">
            <div className="inline-block bg-primary text-white font-bold px-4 py-2 mb-6 -rotate-1 shadow-lg uppercase tracking-wider text-xs sm:text-sm">
              Gebäudereinigung in Bonn für Gewerbe, Objekt & Verwaltung
            </div>
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-3xl border-l-4 border-primary pl-4 md:pl-6 py-2 mb-8 md:mb-10">
              AE Gebäudeservice übernimmt Gebäudereinigung in Bonn für Büros, Praxen,
              Kanzleien, Verwaltungsgebäude, Treppenhäuser und repräsentative Flächen.
              Wir sorgen für gepflegte Eingangsbereiche, saubere Arbeitsflächen,
              hygienische Sanitärbereiche und einen professionellen Eindruck bei Kunden,
        ...
        <div className="container mx-auto px-4 md:px-6 py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="font-black uppercase">Vor Ort in Bonn</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div className="relative min-h-[320px] md:min-h-[500px] overflow-hidden shadow-2xl">
            <Image
              ...
              alt="Reinigungskraft bei der Gebäudereinigung in Bonn"
              title="Reinigungskraft bei der Gebäudereinigung in Bonn"
              fill
          ...
          <div>
            ...
            <div className="space-y-5 text-lg text-text-muted leading-relaxed">
              <p>
                Bonn hat viele repräsentative Büro- und Verwaltungsflächen, Praxen,
                Kanzleien und Immobilien mit hohem Anspruch an gepflegte Außenwirkung.
                Sauberkeit ist hier ein Teil des professionellen Gesamteindrucks.
              </p>

              <p>
                Für Bonn eignet sich Gebäudereinigung, die diskret arbeitet, feste Abläufe
                ermöglicht und besonders auf Empfangsbereiche, Sanitärzonen und
                gemeinschaftliche Flächen achtet.
              </p>

              <p>
                Wir reinigen in Bonn unter anderem rund um Zentrum, Bad Godesberg, Beuel,
                Poppelsdorf, Endenich und Südstadt. Ob regelmäßige Unterhaltsreinigung,
            ...
            >
              ...
              Gebäudereinigung in Bonn anfragen
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-lg text-text-muted leading-relaxed">
              Von der Büroreinigung bis zur Treppenhausreinigung: In Bonn übernehmen wir
              die Reinigung so, dass sie zu Nutzung, Objektgröße, Öffnungszeiten und
      ...
      <section className="py-16 md:py-24 bg-background-light">
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="space-y-5 text-lg text-text-muted leading-relaxed">
              <p>
                Viele Unternehmen und Hausverwaltungen in Bonn suchen nicht irgendeine
              ...
              <p>
                ...
                in Bonn mit unterschiedlichen Objektarten ist es wichtig, dass Reinigung
          ...
          <div className="relative min-h-[320px] md:min-h-[500px] overflow-hidden shadow-2xl">
            <Image
              ...
              alt="Sauberes Objekt nach Gebäudereinigung in Bonn"
              title="Sauberes Objekt nach Gebäudereinigung in Bonn"
              fill
              className="object-cover"
            />
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-start lg:items-center min-w-0">
            <div className="text-white min-w-0">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-md italic break-words">
                Du suchst Gebäudereinigung in Bonn? Ein kurzer Anruf reicht oft, um
      ...
      <section className="py-16 md:py-24 bg-black text-white">
        <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl">
          ...
          <p className="text-lg md:text-2xl text-gray-300 leading-relaxed mb-10">
            ...
            Treppenhausreinigung oder gewerbliche Reinigung in Bonn? Dann ruf jetzt an
            und besprich deinen Einsatz direkt mit uns.
          </p>

...
export const metadata: Metadata = {
  title: "Gebäudereinigung Dortmund | AE Gebäudeservice",
  description:
    "Professionelle Gebäudereinigung in Dortmund für Büro, Gewerbe, Treppenhaus, Praxis und Objektpflege. Schnell, gründlich und zuverlässig. Jetzt anrufen.",
  alternates: {
    canonical: "/gebaeudereinigung/dortmund",
  },
};

export default function GebaeudereinigungDortmundPage() {
  return (
    <>
      <a
      ...
      <section className="relative overflow-hidden bg-background-dark text-white">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Professionelle Gebäudereinigung in Dortmund"
            fill
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 py-20 md:py-28 lg:py-36">
          <div className="max-w-4xl">
            <div className="inline-block bg-primary text-white font-bold px-4 py-2 mb-6 -rotate-1 shadow-lg uppercase tracking-wider text-xs sm:text-sm">
              Gebäudereinigung in Dortmund für Gewerbe, Objekt & Verwaltung
            </div>
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-3xl border-l-4 border-primary pl-4 md:pl-6 py-2 mb-8 md:mb-10">
              AE Gebäudeservice übernimmt Gebäudereinigung in Dortmund für
              Gewerbeflächen, Verwaltungsgebäude, Praxen, Treppenhäuser und
              Betriebsflächen. Wir sorgen für gepflegte Eingangsbereiche, saubere
        ...
        <div className="container mx-auto px-4 md:px-6 py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="font-black uppercase">Vor Ort in Dortmund</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div className="relative min-h-[320px] md:min-h-[500px] overflow-hidden shadow-2xl">
            <Image
              ...
              alt="Reinigungskraft bei der Gebäudereinigung in Dortmund"
              title="Reinigungskraft bei der Gebäudereinigung in Dortmund"
              fill
          ...
          <div>
            <h2 className="text-primary font-bold tracking-widest uppercase text-sm mb-3">
              Sauberkeit mit System in Dortmund
            </h2>
            ...
            <div className="space-y-5 text-lg text-text-muted leading-relaxed">
              <p>
                Dortmund verbindet große Büroflächen, Handwerksbetriebe, medizinische
                Einrichtungen und stark genutzte Gewerbeobjekte. Hier geht es nicht nur um
                Optik, sondern um zuverlässige Reinigung, die den täglichen Betrieb
                unterstützt.
              </p>

              <p>
                In Dortmund sind robuste und planbare Reinigungskonzepte gefragt –
                besonders für Objekte, die täglich viel genutzt werden und trotzdem
                ordentlich wirken müssen.
              </p>

              <p>
                Wir reinigen in Dortmund unter anderem rund um Innenstadt, Hörde,
                Aplerbeck, Brackel, Hombruch und entlang wichtiger Gewerbestandorte. Ob
                regelmäßige Unterhaltsreinigung, Treppenhausreinigung, Büroreinigung oder
                gezielte Objektpflege: Wir stimmen Umfang, Rhythmus und Schwerpunkte
                direkt mit dir ab.
              </p>
            </div>
            ...
            >
              ...
              Gebäudereinigung in Dortmund anfragen
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-lg text-text-muted leading-relaxed">
              Von der Büroreinigung bis zur Treppenhausreinigung: In Dortmund übernehmen
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: "apartment",
                title: "Büroreinigung in Dortmund",
        ...
        <div className="container mx-auto px-4 md:px-6 flex flex-col lg:flex-row gap-6 items-center justify-between">
          <div>
            <h2 className="text-3xl md:text-5xl font-black uppercase italic text-white leading-none">
              Reinigung in Dortmund anfragen
            </h2>
      ...
      <section className="py-16 md:py-24 bg-background-light">
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="space-y-5 text-lg text-text-muted leading-relaxed">
              <p>
                Viele Unternehmen und Hausverwaltungen in Dortmund suchen nicht irgendeine
              ...
              <p>
                ...
                in Dortmund mit unterschiedlichen Objektarten ist es wichtig, dass
          ...
          <div className="relative min-h-[320px] md:min-h-[500px] overflow-hidden shadow-2xl">
            <Image
              ...
              alt="Sauberes Objekt nach Gebäudereinigung in Dortmund"
              title="Sauberes Objekt nach Gebäudereinigung in Dortmund"
              fill
              className="object-cover"
            />
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-start lg:items-center min-w-0">
            <div className="text-white min-w-0">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-md italic break-words">
                Du suchst Gebäudereinigung in Dortmund? Ein kurzer Anruf reicht oft, um
      ...
      <section className="py-16 md:py-24 bg-black text-white">
        <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl">
          ...
          <p className="text-lg md:text-2xl text-gray-300 leading-relaxed mb-10">
            ...
            Treppenhausreinigung oder gewerbliche Reinigung in Dortmund? Dann ruf

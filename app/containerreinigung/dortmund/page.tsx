// app/containerreinigung/dortmund/page.tsx
...
export const metadata: Metadata = {
  title: "Containerreinigung in Dortmund | AE Gebäudeservice",
  description:
    "Containerreinigung in Dortmund: Innenreinigung, Außenreinigung, Sanitärcontainer und komplette Containeranlagen. Hygienisch, gründlich und schnell einsatzbereit.",
  alternates: { canonical: "/containerreinigung/dortmund" },
};
...
export default function DortmundContainerreinigungPage() {
  return (
    <>
      <a
        ...
        <div className="container relative z-10 mx-auto px-4 py-20 md:px-6 md:py-28 lg:py-36">
          <div className="max-w-4xl">
            ...
            <p className="mb-8 max-w-3xl border-l-4 border-primary pl-4 text-lg text-gray-300 sm:text-xl md:mb-10 md:pl-6 md:text-2xl">
              Dortmund hat viele Baustellen, Gewerbeflächen, Industrieareale und temporäre Containerlösungen. Ob Hafen, Innenstadt, Hörde, Aplerbeck, Brackel oder Gewerbegebiet: Wo Container täglich genutzt werden, entstehen Staub, Schmutz und Gebrauchsspuren. Wir reinigen Containeranlagen innen und außen, damit Aufenthaltsräume, Büros und Sanitärcontainer wieder sauber und einsatzbereit sind.
            </p>
        ...
        <div className="container mx-auto grid gap-10 px-4 md:px-6 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <div className="space-y-5 text-lg leading-relaxed text-gray-700">
              ...
              <p>
                Bei Containeranlagen in Dortmund geht es oft um robuste, praktische Sauberkeit. Auf Baustellen und Gewerbeflächen werden Container stark beansprucht, oft von vielen Personen täglich genutzt und müssen trotzdem ordentlich bleiben. Wir übernehmen Innenreinigung, Außenreinigung, Sanitärbereiche und Zugänge mit einem Ablauf, der sich an Baustelle, Betrieb und gewünschtem Termin orientiert.
              </p>
              <p>
                Für Dortmund passend bei Bauprojekten, Industrieflächen, Sanitärcontainern, Mannschaftscontainern und temporären Büroanlagen.
              </p>
            </div>
      ...
      <section className="bg-black py-16 text-white md:py-20">
        <div className="container mx-auto max-w-5xl px-4 text-center md:px-6">
          <h2 className="mb-6 text-4xl font-black uppercase tracking-tight md:text-6xl">
            Containerreinigung in Dortmund
          </h2>

// app/containerreinigung/bochum/page.tsx
...
export const metadata: Metadata = {
  title: "Containerreinigung in Bochum | AE Gebäudeservice",
  description:
    "Containerreinigung in Bochum: Innenreinigung, Außenreinigung, Sanitärcontainer und komplette Containeranlagen. Hygienisch, gründlich und schnell einsatzbereit.",
  alternates: { canonical: "/containerreinigung/bochum" },
};
...
export default function BochumContainerreinigungPage() {
  return (
    <>
      <a
        ...
        <div className="container relative z-10 mx-auto px-4 py-20 md:px-6 md:py-28 lg:py-36">
          <div className="max-w-4xl">
            ...
            <p className="mb-8 max-w-3xl border-l-4 border-primary pl-4 text-lg text-gray-300 sm:text-xl md:mb-10 md:pl-6 md:text-2xl">
              Bochum ist geprägt von Umbauten, Gewerbeobjekten, Wohnprojekten, Campusbereichen und vielen kleineren Baustellen. Container dienen dort oft als flexible Lösung für Teams, Material, Sanitär oder Büro. Wir reinigen Containeranlagen in Bochum gründlich, hygienisch und mit direkter Abstimmung für schnelle Nutzbarkeit.
            </p>
        ...
        <div className="container mx-auto grid gap-10 px-4 md:px-6 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <div className="space-y-5 text-lg leading-relaxed text-gray-700">
              ...
              <p>
                Ob Innenstadt, Wattenscheid, Langendreer, Querenburg oder Gewerbestandort: Container werden in Bochum häufig als Übergangslösung genutzt und müssen trotzdem einen ordentlichen Eindruck machen. Wir kümmern uns um Innenbereiche, Sanitärcontainer, Aufenthaltsräume, Türen, Fenster, Böden und Außenflächen. Ziel ist eine Reinigung, die im Alltag funktioniert und schnell organisiert werden kann.
              </p>
              <p>
                Für Bochum passend bei Baustellencontainern, Uni- und Projektflächen, Gewerbecontainern, Sanitärbereichen und Übergangslösungen.
              </p>
            </div>

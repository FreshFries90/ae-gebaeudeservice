// app/containerreinigung/[city]/page.tsx
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `Containerreinigung in ${cityName} | AE Gebäudeservice`,
    description: `Containerreinigung in ${cityName} für Innen- und Außenbereiche. AE Gebäudeservice reinigt Container gründlich, hygienisch und schnell wieder einsatzbereit. Jetzt direkt anrufen.`,
    alternates: {
      canonical: `/containerreinigung/${city}`,
    },
  };
}

export default async function ContainerreinigungCityPage({ params }: Props) {
  const { city } = await params;
  ...
  return (
    <>
      <a
        ...
        href={`tel:${PHONE}`}
        aria-label={`Jetzt Containerreinigung in ${cityName} anrufen`}
      >
      ...
      <section className="relative overflow-hidden bg-black text-white">
        <div className="absolute inset-0">
          <Image
            ...
            alt={`Containerreinigung in ${cityName}`}
            fill
            priority
        ...
        <div className="container relative z-10 mx-auto px-4 py-20 md:px-6 md:py-28 lg:py-36">
          <div className="max-w-4xl">
            <div className="mb-6 inline-block -rotate-1 bg-primary px-4 py-2 text-xs font-bold uppercase tracking-wider text-white shadow-lg sm:text-sm">
              Spezialreinigung & Hygiene in {cityName}
            </div>
            ...
            <h1 className="mb-6 text-4xl font-black uppercase leading-[0.95] tracking-tighter sm:text-5xl md:text-7xl">
              ...
              <span className="mt-2 block italic text-primary">
                in {cityName} innen & außen gründlich gereinigt
              </span>
            </h1>

            <p className="mb-8 max-w-3xl border-l-4 border-primary pl-4 text-lg text-gray-300 sm:text-xl md:mb-10 md:pl-6 md:text-2xl">
              AE Gebäudeservice reinigt Container in {cityName} innen und außen
              gründlich, hygienisch und zuverlässig. Für saubere
              Containeranlagen, Sanitärcontainer, Bürocontainer und
              Aufenthaltsbereiche, die schnell wieder einsatzbereit sein sollen.
            </p>
        ...
        <div className="container mx-auto grid gap-10 px-4 md:px-6 lg:grid-cols-2 lg:items-center">
          <div className="relative min-h-[320px] overflow-hidden shadow-2xl md:min-h-[520px]">
            <Image
              ...
              alt={`Reinigung von Containerinnenraum in ${cityName}`}
              fill
          ...
          <div>
            <h2 className="mb-3 text-sm font-bold uppercase tracking-widest text-primary">
              Sauberkeit für stark genutzte Container in {cityName}
            </h2>
            ...
            <div className="space-y-5 text-lg leading-relaxed text-gray-700">
              ...
              <p>
                AE Gebäudeservice übernimmt die gründliche Containerreinigung in{" "}
                {cityName} im Innen- und Außenbereich. Wir reinigen Oberflächen,
                Böden, Eingangsbereiche, Sanitärzonen und stark genutzte
                Bereiche sauber, ordentlich und mit Blick auf einen gepflegten
                Gesamteindruck.
              </p>
              ...
              <p>
                ...
                sorgen dafür, dass Container in {cityName} schnell wieder
                einsatzbereit sind.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-12 max-w-3xl">
            ...
            <p className="text-lg leading-relaxed text-gray-700">
              Wir reinigen Container in {cityName} dort, wo Sauberkeit, Hygiene
              und ein gepflegter Zustand wichtig sind von einzelnen Einheiten
              bis zu kompletten Containeranlagen.
            </p>
          </div>
      ...
      <section className="bg-black py-16 text-white md:py-20">
        <div className="container mx-auto max-w-5xl px-4 text-center md:px-6">
          <h2 className="mb-6 text-4xl font-black uppercase tracking-tight md:text-6xl">
            Containerreinigung in {cityName} mit direkter Abstimmung
          </h2>
          <p className="mx-auto max-w-4xl text-lg leading-relaxed text-gray-300 md:text-xl">
            Wenn du eine zuverlässige Containerreinigung in {cityName} suchst,
            brauchst du keine komplizierten Abläufe, sondern einen
            Ansprechpartner, der erreichbar ist und schnell reagiert. AE
            Gebäudeservice reinigt Container innen und außen gründlich,
            hygienisch und passend zum tatsächlichen Einsatz vor Ort.
          </p>
        ...
        <div className="container mx-auto grid gap-10 px-4 md:px-6 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <div className="space-y-5 text-lg leading-relaxed text-gray-700">
              ...
              <p>
                ...
                der Aufwand für dich gering und die Container in {cityName} sind
                schnell wieder in einem sauberen Zustand.
              </p>

              <p>
                Ob einzelner Container oder komplette Anlage: Wenn du eine
                zuverlässige Containerreinigung in {cityName} suchst, kannst du
                uns direkt anrufen und den Einsatz besprechen.
              </p>
            </div>
          </div>
          ...
          <div className="relative min-h-[320px] overflow-hidden shadow-2xl md:min-h-[520px]">
            <Image
              ...
              alt={`Sauber gereinigter Container in ${cityName}`}
              fill
              className="object-cover"
            />
        ...
        <div className="container mx-auto flex flex-col items-center justify-between gap-6 px-4 text-center md:px-6 lg:flex-row lg:text-left">
          <div>
            <h2 className="text-3xl font-black uppercase italic leading-none text-white md:text-5xl">
              Containerreinigung in {cityName} direkt anfragen
            </h2>

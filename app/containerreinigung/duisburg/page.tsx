// app/containerreinigung/duisburg/page.tsx
...
export const metadata: Metadata = {
  title: "Containerreinigung in Duisburg | AE Gebäudeservice",
  description:
    "Containerreinigung in Duisburg: Innenreinigung, Außenreinigung, Sanitärcontainer und komplette Containeranlagen. Hygienisch, gründlich und schnell einsatzbereit.",
  alternates: { canonical: "/containerreinigung/duisburg" },
};
...
export default function DuisburgContainerreinigungPage() {
  return (
    <>
      <a
        ...
        <div className="container relative z-10 mx-auto px-4 py-20 md:px-6 md:py-28 lg:py-36">
          <div className="max-w-4xl">
            ...
            <p className="mb-8 max-w-3xl border-l-4 border-primary pl-4 text-lg text-gray-300 sm:text-xl md:mb-10 md:pl-6 md:text-2xl">
              In Duisburg sind Containerlösungen häufig im Umfeld von Logistik, Industrie, Hafen, Baustellen und Gewerbe im Einsatz. Dort zählt eine Reinigung, die belastbar ist und schnell umgesetzt werden kann. Wir reinigen Bürocontainer, Sanitärcontainer, Aufenthaltscontainer und komplette Containeranlagen innen und außen, damit sie wieder ordentlich und nutzbar sind.
            </p>
        ...
        <div className="container mx-auto grid gap-10 px-4 md:px-6 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <div className="space-y-5 text-lg leading-relaxed text-gray-700">
              ...
              <p>
                Container in Duisburg werden oft unter anspruchsvollen Bedingungen genutzt: Staub, Feuchtigkeit, Arbeitskleidung, Laufwege und intensive Nutzung hinterlassen schnell Spuren. AE Gebäudeservice übernimmt die Containerreinigung mit Fokus auf praktische Hygiene, saubere Oberflächen und gepflegte Außenwirkung. Besonders wichtig sind Sanitärzonen, Eingänge, Böden und stark frequentierte Bereiche.
              </p>
              <p>
                Für Duisburg ideal bei Hafen- und Logistikstandorten, Industriegeländen, Baucontainern, Sanitärcontainern und Aufenthaltsbereichen.
              </p>
            </div>
      ...
      <section className="bg-black py-16 text-white md:py-20">
        <div className="container mx-auto max-w-5xl px-4 text-center md:px-6">
          <h2 className="mb-6 text-4xl font-black uppercase tracking-tight md:text-6xl">
            Containerreinigung in Duisburg
          </h2>

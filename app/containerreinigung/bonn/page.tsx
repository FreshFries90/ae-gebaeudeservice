// app/containerreinigung/bonn/page.tsx
...
export const metadata: Metadata = {
  title: "Containerreinigung in Bonn | AE Gebäudeservice",
  description:
    "Containerreinigung in Bonn: Innenreinigung, Außenreinigung, Sanitärcontainer und komplette Containeranlagen. Hygienisch, gründlich und schnell einsatzbereit.",
  alternates: { canonical: "/containerreinigung/bonn" },
};
...
export default function BonnContainerreinigungPage() {
  return (
    <>
      <a
        ...
        <div className="container relative z-10 mx-auto px-4 py-20 md:px-6 md:py-28 lg:py-36">
          <div className="max-w-4xl">
            ...
            <p className="mb-8 max-w-3xl border-l-4 border-primary pl-4 text-lg text-gray-300 sm:text-xl md:mb-10 md:pl-6 md:text-2xl">
              Bonn hat viele Bürostandorte, öffentliche Einrichtungen, Sanierungsprojekte und temporäre Flächen, bei denen Container gepflegt wirken müssen. Wir reinigen Bürocontainer, Sanitärcontainer, Aufenthaltscontainer und komplette Anlagen in Bonn innen und außen, damit Nutzung, Hygiene und Eindruck wieder stimmen.
            </p>
        ...
        <div className="container mx-auto grid gap-10 px-4 md:px-6 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <div className="space-y-5 text-lg leading-relaxed text-gray-700">
              ...
              <p>
                In Bonn steht bei Containerreinigung oft nicht nur robuste Sauberkeit, sondern auch ein ordentlicher, repräsentativer Eindruck im Vordergrund. Container an Büro-, Verwaltungs-, Bildungs- oder Baustellenstandorten werden von vielen Menschen genutzt und sollten sauber, hygienisch und gepflegt bleiben. Wir übernehmen die Reinigung von Böden, Oberflächen, Sanitärzonen, Fenstern, Eingängen und Außenflächen.
              </p>
              <p>
                Für Bonn ideal bei Verwaltungsstandorten, Bürocontainern, öffentlichen Einrichtungen, Baustellen und temporären Sanitäranlagen.
              </p>
            </div>

// app/containerreinigung/aachen/page.tsx
...
export const metadata: Metadata = {
  title: "Containerreinigung in Aachen | AE Gebäudeservice",
  description:
    "Containerreinigung in Aachen: Innenreinigung, Außenreinigung, Sanitärcontainer und komplette Containeranlagen. Hygienisch, gründlich und schnell einsatzbereit.",
  alternates: { canonical: "/containerreinigung/aachen" },
};
...
export default function AachenContainerreinigungPage() {
  return (
    <>
      <a
        ...
        <div className="container relative z-10 mx-auto px-4 py-20 md:px-6 md:py-28 lg:py-36">
          <div className="max-w-4xl">
            ...
            <p className="mb-8 max-w-3xl border-l-4 border-primary pl-4 text-lg text-gray-300 sm:text-xl md:mb-10 md:pl-6 md:text-2xl">
              Aachen verbindet Hochschulstandorte, Gewerbe, Forschung, Sanierungen und viele innerstädtische Projekte. Container werden dort oft als flexible Arbeits-, Sanitär- oder Aufenthaltslösung eingesetzt. Wir reinigen Container innen und außen, damit sie gepflegt, hygienisch und schnell wieder nutzbar sind.
            </p>
        ...
        <div className="container mx-auto grid gap-10 px-4 md:px-6 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <div className="space-y-5 text-lg leading-relaxed text-gray-700">
              ...
              <p>
                In Aachen stehen Containeranlagen häufig an Baustellen, Campus- und Forschungsstandorten, Gewerbeflächen oder bei Sanierungen. Durch tägliche Nutzung entstehen Verschmutzungen an Böden, Griffen, Türen, Sanitärbereichen und Außenflächen. AE Gebäudeservice übernimmt die Containerreinigung gründlich und mit Blick auf die jeweilige Nutzung vor Ort.
              </p>
              <p>
                Für Aachen sinnvoll bei Campusprojekten, Bürocontainern, Baustellencontainern, Sanitärcontainern und temporären Projektstandorten.
              </p>
            </div>

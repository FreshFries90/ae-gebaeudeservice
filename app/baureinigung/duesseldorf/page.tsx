...
export const metadata: Metadata = {
  title: "Baureinigung Düsseldorf | AE Gebäudeservice",
  description:
    "Baureinigung in Düsseldorf: Baugrobreinigung, Baufeinreinigung und Bauendreinigung für Neubau, Umbau und Sanierung. Jetzt Termin sichern.",
  alternates: { canonical: "/baureinigung/duesseldorf" },
};
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 items-center w-full min-w-0">
            <div className="lg:col-span-7 min-w-0">
              <div className="inline-block max-w-full break-words bg-primary text-white font-bold px-3 sm:px-4 py-1 mb-6 md:mb-8 -rotate-1 shadow-lg uppercase tracking-wider text-xs sm:text-sm">
                In Düsseldorf zählt bei vielen Bauprojekten ein hochwertiger erster Eindruck – besonders bei Büros, Praxen, Showrooms und Eigentumswohnungen.
              </div>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-2xl border-l-4 border-primary pl-4 md:pl-6 py-2 break-words">
                Von der Baufeinreinigung im MedienHafen bis zur Sanierungsreinigung in Bilk: Wir sorgen für saubere Flächen, klare Oberflächen und eine Übergabe ohne vermeidbaren Baustellenstaub.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mb-10 md:mb-16 items-stretch sm:items-center min-w-0">
                <a
                  ...
                  href={`tel:${PHONE}`}
                >
                  <span className="material-icons-outlined text-3xl md:text-4xl animate-pulse shrink-0">phone_in_talk</span>
            ...
            <div className="lg:col-span-5 hidden lg:block min-w-0">
              <div className="relative w-full max-w-lg aspect-square mask-blob shadow-2xl bg-gray-800 mx-auto overflow-hidden">
                <Image
                  alt="Baureinigung in Düsseldorf"
        ...
        <div className="w-full bg-white py-8 sm:py-10 relative z-20 border-t-4 border-primary mt-8 md:mt-12">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10 md:gap-24 grayscale opacity-70 hover:grayscale-0 transition-all text-center">
              {[
                ["construction", "Baugrob- & Feinreinigung"],
                ["event_available", "Termingerechte Einsätze"],
                ["fact_check", "Sauber zur Übergabe"],
                ["groups", "Eingespielte Teams"],
              ].map(([icon, label]) => (
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mb-12 md:mb-16">
            <h2 className="text-primary font-bold tracking-widest uppercase text-xs sm:text-sm mb-3 break-words">
              Baureinigung in Düsseldorf für anspruchsvolle Übergaben
            </h2>
            <h3 className="text-4xl sm:text-5xl md:text-7xl font-black text-gray-900 uppercase tracking-tight mb-6 break-words">
              Baureinigung Düsseldorf: gründlich, diskret und terminsicher
            </h3>
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed break-words">
              Düsseldorf hat viele Objekte, bei denen die Reinigung nach dem Bau nicht nur praktisch, sondern repräsentativ sein muss. Wenn Kunden, Mieter oder Eigentümer zum ersten Mal durch die Räume gehen, dürfen Staub, Schlieren und Rückstände nicht das Bild bestimmen.
            </p>
            <p className="mt-6 text-lg sm:text-xl text-gray-700 leading-relaxed break-words">
              Unsere Baureinigung konzentriert sich auf genau diesen Moment. Wir reinigen Böden, Glasflächen, Rahmen, Türen, Schalter, Sanitärbereiche und Oberflächen nach Baufortschritt und Übergabetermin. So bleibt der Ablauf planbar und das Ergebnis wirkt nicht improvisiert.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-gray-50 border-l-8 border-primary p-6 sm:p-8 md:p-10">
              <span className="material-icons-outlined text-primary text-4xl md:text-5xl mb-6 block">handyman</span>
              <h4 className="text-2xl sm:text-3xl font-black uppercase mb-4 break-words">Baugrobreinigung</h4>
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed break-words">
                Grober Schmutz, Verpackungen, Folien, Materialreste und Baustellenrückstände werden entfernt, damit Arbeitsbereiche in Düsseldorf wieder ordentlich nutzbar sind.
              </p>
            </div>

            <div className="bg-primary text-white p-6 sm:p-8 md:p-10">
              <span className="material-icons-outlined text-white text-4xl md:text-5xl mb-6 block">cleaning_services</span>
              <h4 className="text-2xl sm:text-3xl font-black uppercase mb-4 break-words">Baufeinreinigung</h4>
              <p className="text-white/80 text-base sm:text-lg leading-relaxed break-words">
                Böden, Fenster, Rahmen, Sanitärbereiche, Türen, Schalter und Oberflächen werden gründlich gereinigt, damit das Objekt übergabebereit wirkt.
              </p>
            </div>

            <div className="bg-black text-white p-6 sm:p-8 md:p-10">
              <span className="material-icons-outlined text-primary text-4xl md:text-5xl mb-6 block">apartment</span>
              <h4 className="text-2xl sm:text-3xl font-black uppercase mb-4 break-words">Bauendreinigung</h4>
              <p className="text-gray-400 text-base sm:text-lg leading-relaxed break-words">
                Für Übergabe, Einzug, Abnahme oder Neueröffnung stimmen wir die Reinigung auf die fertigen Bauabschnitte und den Terminplan ab.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-start">
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 uppercase mb-6 break-words">
                Worauf es in Düsseldorf besonders ankommt
              </h2>
              <div className="space-y-5 text-gray-700 text-base sm:text-lg leading-relaxed">
                <p className="break-words">Besonders passend für hochwertige Wohnungen, Büroflächen, Praxen, Kanzleien, Retailflächen und Objektübergaben in Düsseldorf.</p>
                <p className="break-words">
                  Häufig reinigen wir in Stadtmitte, Pempelfort, Bilk, Derendorf, Oberkassel, Benrath und MedienHafen. Je nach Lage prüfen wir vorab, wie Zugang, Parkmöglichkeit, Aufzug, Baufortschritt und Zeitfenster zusammenpassen. So entsteht ein realistischer Ablauf statt unnötiger Hektik am Ende.
                </p>
                <p className="break-words">
                  Entscheidend ist, dass die Räume nach der Reinigung nicht mehr nach Baustelle aussehen. Dafür arbeiten wir systematisch von groben Rückständen bis zu sichtbaren Details an Glas, Rahmen, Böden und Kontaktflächen.
                </p>
              </div>
            </div>

            <div className="bg-white p-6 sm:p-8 md:p-10 shadow-xl border-t-4 border-primary">
              <h3 className="text-2xl sm:text-3xl font-black uppercase mb-6 break-words">Typische Einsätze in Düsseldorf</h3>
              <ul className="space-y-4 text-gray-700 text-base sm:text-lg">
                <li className="flex gap-3">
                  ...
                  <span className="break-words">Baufeinreinigung für hochwertige Innenräume</span>
                </li>
                <li className="flex gap-3">
                  <span className="material-icons-outlined text-primary shrink-0">check_circle</span>
                  <span className="break-words">Reinigung nach Umbau im laufenden Betrieb</span>
                </li>
                <li className="flex gap-3">
                  <span className="material-icons-outlined text-primary shrink-0">check_circle</span>
                  <span className="break-words">Saubere Übergabe von Büros und Praxen</span>
                </li>
                <li className="flex gap-3">
                  <span className="material-icons-outlined text-primary shrink-0">check_circle</span>
                  <span className="break-words">Glas-, Rahmen- und Bodenreinigung</span>
                </li>
                <li className="flex gap-3">
                  <span className="material-icons-outlined text-primary shrink-0">check_circle</span>
                  <span className="break-words">Abstimmung mit Hausverwaltung oder Bauleitung</span>
                </li>
                <li className="flex gap-3">
                  <span className="material-icons-outlined text-primary shrink-0">check_circle</span>
                  <span className="break-words">Terminsichere Einsätze im Stadtgebiet</span>
                </li>
              </ul>
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-gray-900 overflow-hidden relative">
        <div className="container mx-auto px-4 text-center min-w-0">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white uppercase mb-6 md:mb-8 break-words">
            Baureinigung in Düsseldorf kurzfristig abstimmen?
          </h2>
          <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-10 md:mb-12 break-words">
            Rufen Sie kurz an. Oft lässt sich direkt klären, welcher Umfang gebraucht wird und wann der Einsatz sinnvoll stattfinden kann.
          </p>
          ...
          <div className="inline-block max-w-full p-1 bg-gradient-to-r from-primary to-primary-accent rounded-2xl shadow-[0_0_50px_rgba(22,163,74,0.3)] w-full sm:w-auto">
            <div className="bg-black px-4 sm:px-10 md:px-12 py-8 sm:py-10 rounded-xl">
              <p className="text-primary font-black uppercase tracking-[0.3em] mb-4 text-xs sm:text-sm break-words">Direkt am Telefon</p>
              <a
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-start lg:items-center min-w-0">
            <div className="text-white min-w-0">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-md italic break-words">
                Ob einzelne Bauendreinigung oder regelmäßige Unterstützung auf der Baustelle: Wir schauen uns an, was in Düsseldorf gebraucht wird.
              </p>

...
export const metadata: Metadata = {
  title: "Baureinigung Krefeld | AE Gebäudeservice",
  description:
    "Baureinigung in Krefeld: Baugrobreinigung, Baufeinreinigung und Bauendreinigung für Neubau, Umbau und Sanierung. Jetzt Termin sichern.",
  alternates: { canonical: "/baureinigung/krefeld" },
};
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 items-center w-full min-w-0">
            <div className="lg:col-span-7 min-w-0">
              <div className="inline-block max-w-full break-words bg-primary text-white font-bold px-3 sm:px-4 py-1 mb-6 md:mb-8 -rotate-1 shadow-lg uppercase tracking-wider text-xs sm:text-sm">
                Krefeld hat viele Wohn-, Gewerbe- und Industrieflächen – bei der Baureinigung zählt daher robuste Gründlichkeit.
              </div>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-2xl border-l-4 border-primary pl-4 md:pl-6 py-2 break-words">
                Wir reinigen Krefelder Baustellenbereiche nach Neubau, Umbau und Renovierung – sauber, strukturiert und passend zum Übergabetermin.
              </p>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mb-12 md:mb-16">
            <h2 className="text-primary font-bold tracking-widest uppercase text-xs sm:text-sm mb-3 break-words">
              Baureinigung in Krefeld für Gewerbe, Wohnbau und Sanierung
            </h2>
            <h3 className="text-4xl sm:text-5xl md:text-7xl font-black text-gray-900 uppercase tracking-tight mb-6 break-words">
              Baureinigung Krefeld: von der Baustelle zur nutzbaren Fläche
            </h3>
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed break-words">
              In Krefeld reicht die Bandbreite vom sanierten Wohnobjekt bis zur Gewerbeeinheit mit stärkerer Nutzung. Nach Bauarbeiten bleiben oft Staub, Materialreste, Laufspuren und Verschmutzungen zurück, die vor der Nutzung gründlich entfernt werden müssen.
            </p>
            <p className="mt-6 text-lg sm:text-xl text-gray-700 leading-relaxed break-words">
              Wir übernehmen Baugrobreinigung, Baufeinreinigung oder einzelne Reinigungsabschnitte. Dabei geht es nicht um Kosmetik, sondern um Flächen, die sauber, sicher und bereit für den nächsten Schritt sind.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-gray-50 border-l-8 border-primary p-6 sm:p-8 md:p-10">
              ...
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed break-words">
                Grober Schmutz, Verpackungen, Folien, Materialreste und Baustellenrückstände werden entfernt, damit Arbeitsbereiche in Krefeld wieder ordentlich nutzbar sind.
              </p>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-start">
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 uppercase mb-6 break-words">
                Worauf es in Krefeld besonders ankommt
              </h2>
              <div className="space-y-5 text-gray-700 text-base sm:text-lg leading-relaxed">
                <p className="break-words">Für Wohnanlagen, Gewerbeflächen, Büros, Praxen, Eigentümer und Bauunternehmen in Krefeld.</p>
                <p className="break-words">
                  Häufig reinigen wir in Stadtmitte, Uerdingen, Fischeln, Hüls, Oppum, Bockum und Linn. Je nach Lage prüfen wir vorab, wie Zugang, Parkmöglichkeit, Aufzug, Baufortschritt und Zeitfenster zusammenpassen. So entsteht ein realistischer Ablauf statt unnötiger Hektik am Ende.
                </p>
                <p className="break-words">
            ...
            <div className="bg-white p-6 sm:p-8 md:p-10 shadow-xl border-t-4 border-primary">
              <h3 className="text-2xl sm:text-3xl font-black uppercase mb-6 break-words">Typische Einsätze in Krefeld</h3>
              <ul className="space-y-4 text-gray-700 text-base sm:text-lg">
                <li className="flex gap-3">
                  ...
                  <span className="break-words">Baugrobreinigung bei stärkerem Schmutz</span>
                </li>
                <li className="flex gap-3">
                  <span className="material-icons-outlined text-primary shrink-0">check_circle</span>
                ...
                <li className="flex gap-3">
                  <span className="material-icons-outlined text-primary shrink-0">check_circle</span>
                  <span className="break-words">Reinigung von Gewerbe- und Wohnflächen</span>
                </li>
                <li className="flex gap-3">
                  <span className="material-icons-outlined text-primary shrink-0">check_circle</span>
                ...
                <li className="flex gap-3">
                  <span className="material-icons-outlined text-primary shrink-0">check_circle</span>
                  <span className="break-words">Verlässliche Termine in Krefeld</span>
                </li>
              </ul>
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-gray-900 overflow-hidden relative">
        <div className="container mx-auto px-4 text-center min-w-0">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white uppercase mb-6 md:mb-8 break-words">
            Baureinigung in Krefeld kurzfristig abstimmen?
          </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-start lg:items-center min-w-0">
            <div className="text-white min-w-0">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-md italic break-words">
                Ob einzelne Bauendreinigung oder regelmäßige Unterstützung auf der Baustelle: Wir schauen uns an, was in Krefeld gebraucht wird.
              </p>

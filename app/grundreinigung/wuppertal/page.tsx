...
export const metadata: Metadata = {
  title: "Grundreinigung in Wuppertal | AE Gebäudeservice",
  description:
    "Professionelle Grundreinigung in Wuppertal: Büros, Praxen, Treppenhäuser, Gewerbeflächen und Objekte nach Umbau oder Auszug. Jetzt Termin sichern.",
  alternates: { canonical: "/grundreinigung/wuppertal" },
};
...
const cityNeeds = ["Treppenhäuser, Eingänge und Gemeinschaftsflächen", "Büros, Praxen und kleinere Gewerbeeinheiten", "Flächen nach Umbau, Auszug oder Leerstand", "Böden, Sanitärbereiche und Griffzonen mit sichtbaren Nutzungsspuren"];

const faqs = [
  {
    question: "Was kostet eine Grundreinigung in Wuppertal?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Ja, bei vielen Objekten in Wuppertal sind Termine am Abend, am Wochenende oder in betriebsschwachen Zeiten sinnvoll. Wir stimmen das passend zu Ihrem Objekt ab.",
  },
  {
...
export default function GrundreinigungWuppertalPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Grundreinigung in Wuppertal",
    ...
    description:
      "Professionelle Grundreinigung für Büros, Praxen, Treppenhäuser, Gewerbeflächen und Wohnobjekte in Wuppertal.",
  };
    ...
    <main className="bg-white text-black overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-24">
          <div className="flex flex-col justify-center">
            <div className="mb-6 inline-flex w-fit items-center gap-2 bg-primary px-4 py-2 text-xs font-black uppercase tracking-[0.2em] text-white">
              ...
              Grundreinigung Wuppertal
            </div>

            <h1 className="max-w-4xl text-4xl font-black uppercase leading-[0.95] tracking-tight sm:text-5xl md:text-7xl">
              Grundreinigung in Wuppertal für sichtbar saubere Flächen
            </h1>

            <p className="mt-6 max-w-2xl text-lg font-medium leading-relaxed text-white/80 sm:text-xl">
              Professionelle Grundreinigung für Objekte in Hanglagen, Altbauten, Büroflächen und Gewerbeeinheiten mit oft anspruchsvollem Zugang. Wir bringen Böden,
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="space-y-5 text-lg leading-relaxed text-gray-700">
            <p>Wuppertal bringt durch seine Stadtstruktur besondere Herausforderungen mit: enge Zufahrten, Altbauten, verschiedene Ebenen und stark genutzte Treppenhäuser. Unsere Grundreinigung berücksichtigt diese Besonderheiten schon bei der Planung.</p>
            <p>In Elberfeld, Barmen oder Vohwinkel zählt oft nicht nur die Reinigung selbst, sondern auch eine realistische Einschätzung von Zugang, Materialtransport und Zeitfenster.</p>
            <p>Für Wuppertal planen wir Grundreinigungen besonders praktisch: erst die stark belasteten Bereiche, dann Details wie Kanten, Sockel, Ecken und Kontaktflächen.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-100 px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <p className="text-sm font-black uppercase tracking-[0.25em] text-primary">
              Typische Einsätze in Wuppertal
            </p>
            <h2 className="mt-3 text-3xl font-black uppercase sm:text-5xl">
              Dafür werden wir in Wuppertal häufig angefragt
            </h2>
          </div>
      ...
      <section className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-16 sm:px-6 lg:grid-cols-3 lg:px-8 lg:py-24">
        <div className="bg-black p-8 text-white lg:col-span-1">
          ...
          <h2 className="mt-6 text-3xl font-black uppercase">Vor Ort in Wuppertal</h2>
          <p className="mt-4 text-white/75">
            Einsatz in Elberfeld, Barmen, Vohwinkel, Ronsdorf, Cronenberg und Oberbarmen. Weitere Stadtteile und angrenzende Orte prüfen wir
            gerne direkt mit.
          </p>
        </div>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 lg:grid-cols-[1fr_0.9fr]">
          <div>
            ...
            <p className="mt-6 text-lg leading-relaxed text-white/75">
              Eine Grundreinigung in Wuppertal ist sinnvoll, wenn Böden stumpf wirken,
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
          <div>
            <h2 className="text-3xl font-black uppercase sm:text-4xl">
              Grundreinigung in Wuppertal anfragen
            </h2>

...
export const metadata: Metadata = {
  title: "Grundreinigung in Bielefeld | AE Gebäudeservice",
  description:
    "Professionelle Grundreinigung in Bielefeld: Büros, Praxen, Treppenhäuser, Gewerbeflächen und Objekte nach Umbau oder Auszug. Jetzt Termin sichern.",
  alternates: { canonical: "/grundreinigung/bielefeld" },
};
...
const cityNeeds = ["Büroflächen, Besprechungsräume und Empfangsbereiche", "Praxen, Studios und hygienisch sensible Räume", "Treppenhäuser, Eingänge und Gemeinschaftsflächen", "Objekte nach Renovierung, Mieterwechsel oder Grundsanierung"];

const faqs = [
  {
    question: "Was kostet eine Grundreinigung in Bielefeld?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Ja, bei vielen Objekten in Bielefeld sind Termine am Abend, am Wochenende oder in betriebsschwachen Zeiten sinnvoll. Wir stimmen das passend zu Ihrem Objekt ab.",
  },
  {
...
export default function GrundreinigungBielefeldPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Grundreinigung in Bielefeld",
    ...
    description:
      "Professionelle Grundreinigung für Büros, Praxen, Treppenhäuser, Gewerbeflächen und Wohnobjekte in Bielefeld.",
  };
    ...
    <main className="bg-white text-black overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-24">
          <div className="flex flex-col justify-center">
            <div className="mb-6 inline-flex w-fit items-center gap-2 bg-primary px-4 py-2 text-xs font-black uppercase tracking-[0.2em] text-white">
              ...
              Grundreinigung Bielefeld
            </div>

            <h1 className="max-w-4xl text-4xl font-black uppercase leading-[0.95] tracking-tight sm:text-5xl md:text-7xl">
              Grundreinigung in Bielefeld für sichtbar saubere Flächen
            </h1>

            <p className="mt-6 max-w-2xl text-lg font-medium leading-relaxed text-white/80 sm:text-xl">
              Professionelle Grundreinigung für Büros, Praxen, soziale Einrichtungen, Ladenflächen und gepflegte Wohnanlagen mit planbarem Reinigungsbedarf. Wir bringen Böden,
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="space-y-5 text-lg leading-relaxed text-gray-700">
            <p>In Bielefeld steht bei vielen Objekten eine verlässliche und planbare Reinigung im Vordergrund. Ob Gewerbefläche, Praxis, Büro oder Wohnanlage: Eine Grundreinigung bringt Ordnung in Bereiche, die im Alltag stark beansprucht wurden.</p>
            <p>Von Mitte bis Brackwede unterscheiden sich die Anforderungen: Wir reinigen sowohl repräsentative Flächen als auch robuste Nutzbereiche mit hoher Frequenz.</p>
            <p>Für Bielefeld setzen wir auf klare Kommunikation, saubere Zeitplanung und ein Ergebnis, das wieder eine gute Basis für regelmäßige Unterhaltsreinigung schafft.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-100 px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <p className="text-sm font-black uppercase tracking-[0.25em] text-primary">
              Typische Einsätze in Bielefeld
            </p>
            <h2 className="mt-3 text-3xl font-black uppercase sm:text-5xl">
              Dafür werden wir in Bielefeld häufig angefragt
            </h2>
          </div>
      ...
      <section className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-16 sm:px-6 lg:grid-cols-3 lg:px-8 lg:py-24">
        <div className="bg-black p-8 text-white lg:col-span-1">
          ...
          <h2 className="mt-6 text-3xl font-black uppercase">Vor Ort in Bielefeld</h2>
          <p className="mt-4 text-white/75">
            Einsatz in Mitte, Brackwede, Schildesche, Sennestadt, Heepen und Jöllenbeck. Weitere Stadtteile und angrenzende Orte prüfen wir
            gerne direkt mit.
          </p>
        </div>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 lg:grid-cols-[1fr_0.9fr]">
          <div>
            ...
            <p className="mt-6 text-lg leading-relaxed text-white/75">
              Eine Grundreinigung in Bielefeld ist sinnvoll, wenn Böden stumpf wirken,
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
          <div>
            <h2 className="text-3xl font-black uppercase sm:text-4xl">
              Grundreinigung in Bielefeld anfragen
            </h2>

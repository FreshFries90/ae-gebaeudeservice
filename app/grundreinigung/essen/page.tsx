...
export const metadata: Metadata = {
  title: "Grundreinigung in Essen | AE Gebäudeservice",
  description:
    "Professionelle Grundreinigung in Essen: Büros, Praxen, Treppenhäuser, Gewerbeflächen und Objekte nach Umbau oder Auszug. Jetzt Termin sichern.",
  alternates: { canonical: "/grundreinigung/essen" },
};
...
const cityNeeds = ["Büros und Verwaltungsflächen mit stark beanspruchten Laufwegen", "Treppenhäuser und Eingänge in Mehrfamilienhäusern", "Praxen, Behandlungsräume und Wartebereiche", "Flächen nach Auszug, Umbau oder längerer Vernachlässigung"];

const faqs = [
  {
    question: "Was kostet eine Grundreinigung in Essen?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Ja, bei vielen Objekten in Essen sind Termine am Abend, am Wochenende oder in betriebsschwachen Zeiten sinnvoll. Wir stimmen das passend zu Ihrem Objekt ab.",
  },
  {
...
export default function GrundreinigungEssenPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Grundreinigung in Essen",
    areaServed: "Essen",
    provider: {
      "@type": "LocalBusiness",
    ...
    description:
      "Professionelle Grundreinigung für Büros, Praxen, Treppenhäuser, Gewerbeflächen und Wohnobjekte in Essen.",
  };
    ...
    <main className="bg-white text-black overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-24">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="max-w-4xl text-4xl font-black uppercase leading-[0.95] tracking-tight sm:text-5xl md:text-7xl">
              Grundreinigung in Essen für sichtbar saubere Flächen
            </h1>

            <p className="mt-6 max-w-2xl text-lg font-medium leading-relaxed text-white/80 sm:text-xl">
              Professionelle Grundreinigung für Bürohäuser, Praxen, Ladenlokale, Mehrfamilienhäuser und gewachsene Gewerbeflächen zwischen Innenstadt und Stadtteilen. Wir bringen Böden,
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="space-y-5 text-lg leading-relaxed text-gray-700">
            <p>In Essen kommen viele Flächentypen zusammen: moderne Büros, Praxen, Ladenlokale, Wohnanlagen und ältere Bestandsgebäude. Unsere Grundreinigung ist darauf ausgelegt, auch hartnäckige Nutzungsspuren zu beseitigen und Flächen wieder klar, gepflegt und vorzeigbar zu machen.</p>
            <p>Besonders in Rüttenscheid, Steele oder der Innenstadt zählt oft ein sauberer Gesamteindruck, während in größeren Objekten die effiziente Abwicklung im Vordergrund steht.</p>
            <p>Wir planen Essener Grundreinigungen so, dass Böden, Sanitärbereiche, Küchenzonen und Griffspuren systematisch abgearbeitet werden.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-100 px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <p className="text-sm font-black uppercase tracking-[0.25em] text-primary">
              Typische Einsätze in Essen
            </p>
            <h2 className="mt-3 text-3xl font-black uppercase sm:text-5xl">
              Dafür werden wir in Essen häufig angefragt
            </h2>
          </div>
      ...
      <section className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-16 sm:px-6 lg:grid-cols-3 lg:px-8 lg:py-24">
        <div className="bg-black p-8 text-white lg:col-span-1">
          ...
          <h2 className="mt-6 text-3xl font-black uppercase">Vor Ort in Essen</h2>
          <p className="mt-4 text-white/75">
            Einsatz in Rüttenscheid, Innenstadt, Altenessen, Steele, Borbeck und Südviertel. Weitere Stadtteile und angrenzende Orte prüfen wir
            gerne direkt mit.
          </p>
        </div>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 lg:grid-cols-[1fr_0.9fr]">
          <div>
            ...
            <p className="mt-6 text-lg leading-relaxed text-white/75">
              Eine Grundreinigung in Essen ist sinnvoll, wenn Böden stumpf wirken,
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
          <div>
            <h2 className="text-3xl font-black uppercase sm:text-4xl">
              Grundreinigung in Essen anfragen
            </h2>

...
export const metadata: Metadata = {
  title: "Grundreinigung in Mönchengladbach | AE Gebäudeservice",
  description:
    "Professionelle Grundreinigung in Mönchengladbach: Büros, Praxen, Treppenhäuser, Gewerbeflächen und Objekte nach Umbau oder Auszug. Jetzt Termin sichern.",
  alternates: { canonical: "/grundreinigung/moenchengladbach" },
};
...
const cityNeeds = ["Büros, Praxen und Dienstleistungsflächen", "Treppenhäuser und Gemeinschaftsbereiche", "Ladenlokale und Gewerbeflächen nach hoher Nutzung", "Sanitär-, Küchen- und Aufenthaltsbereiche"];

const faqs = [
  {
    question: "Was kostet eine Grundreinigung in Mönchengladbach?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Ja, bei vielen Objekten in Mönchengladbach sind Termine am Abend, am Wochenende oder in betriebsschwachen Zeiten sinnvoll. Wir stimmen das passend zu Ihrem Objekt ab.",
  },
  {
...
export default function GrundreinigungMoenchengladbachPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Grundreinigung in Mönchengladbach",
    ...
    description:
      "Professionelle Grundreinigung für Büros, Praxen, Treppenhäuser, Gewerbeflächen und Wohnobjekte in Mönchengladbach.",
  };
    ...
    <main className="bg-white text-black overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-24">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="max-w-4xl text-4xl font-black uppercase leading-[0.95] tracking-tight sm:text-5xl md:text-7xl">
              Grundreinigung in Mönchengladbach für sichtbar saubere Flächen
            </h1>

            <p className="mt-6 max-w-2xl text-lg font-medium leading-relaxed text-white/80 sm:text-xl">
              Professionelle Grundreinigung für Büros, Praxen, Textil- und Gewerbeflächen, Wohnanlagen und Ladenlokale mit unterschiedlichsten Anforderungen. Wir bringen Böden,
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.25em] text-primary">
              Mönchengladbacher Objektpflege
            </p>
          ...
          <div className="space-y-5 text-lg leading-relaxed text-gray-700">
            <p>Mönchengladbach hat viele gewachsene Gewerbe- und Wohnstrukturen. Bei Grundreinigungen ist deshalb wichtig, dass nicht nach Schema F gearbeitet wird, sondern passend zum Objekt: mal repräsentativ, mal robust, mal besonders zeitkritisch.</p>
            <p>In Rheydt, Wickrath oder Hardt unterscheiden sich Objekte oft stark in Größe, Zugang und Nutzungsgrad. Wir passen Ablauf und Leistung entsprechend an.</p>
            <p>Für Mönchengladbach kombinieren wir gründliche Boden- und Detailreinigung mit klarer Planung, damit die Fläche schnell wieder eingesetzt werden kann.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-100 px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <p className="text-sm font-black uppercase tracking-[0.25em] text-primary">
              Typische Einsätze in Mönchengladbach
            </p>
            <h2 className="mt-3 text-3xl font-black uppercase sm:text-5xl">
              Dafür werden wir in Mönchengladbach häufig angefragt
            </h2>
          </div>
      ...
      <section className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-16 sm:px-6 lg:grid-cols-3 lg:px-8 lg:py-24">
        <div className="bg-black p-8 text-white lg:col-span-1">
          ...
          <h2 className="mt-6 text-3xl font-black uppercase">Vor Ort in Mönchengladbach</h2>
          <p className="mt-4 text-white/75">
            Einsatz in Rheydt, Gladbach, Wickrath, Odenkirchen, Hardt und Neuwerk. Weitere Stadtteile und angrenzende Orte prüfen wir
            gerne direkt mit.
          </p>
        </div>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 lg:grid-cols-[1fr_0.9fr]">
          <div>
            ...
            <p className="mt-6 text-lg leading-relaxed text-white/75">
              Eine Grundreinigung in Mönchengladbach ist sinnvoll, wenn Böden stumpf wirken,
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
          <div>
            <h2 className="text-3xl font-black uppercase sm:text-4xl">
              Grundreinigung in Mönchengladbach anfragen
            </h2>

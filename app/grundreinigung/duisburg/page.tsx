...
export const metadata: Metadata = {
  title: "Grundreinigung in Duisburg | AE Gebäudeservice",
  description:
    "Professionelle Grundreinigung in Duisburg: Büros, Praxen, Treppenhäuser, Gewerbeflächen und Objekte nach Umbau oder Auszug. Jetzt Termin sichern.",
  alternates: { canonical: "/grundreinigung/duisburg" },
};
...
const cityNeeds = ["Büro- und Sozialräume in Gewerbebetrieben", "Treppenhäuser, Eingänge und Gemeinschaftsflächen", "Ladenlokale und Praxisflächen nach intensiver Nutzung", "Sanitärbereiche, Küchen und Aufenthaltsräume"];

const faqs = [
  {
    question: "Was kostet eine Grundreinigung in Duisburg?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Ja, bei vielen Objekten in Duisburg sind Termine am Abend, am Wochenende oder in betriebsschwachen Zeiten sinnvoll. Wir stimmen das passend zu Ihrem Objekt ab.",
  },
  {
...
export default function GrundreinigungDuisburgPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Grundreinigung in Duisburg",
    areaServed: "Duisburg",
    provider: {
      "@type": "LocalBusiness",
    ...
    description:
      "Professionelle Grundreinigung für Büros, Praxen, Treppenhäuser, Gewerbeflächen und Wohnobjekte in Duisburg.",
  };
    ...
    <main className="bg-white text-black overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-24">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="max-w-4xl text-4xl font-black uppercase leading-[0.95] tracking-tight sm:text-5xl md:text-7xl">
              Grundreinigung in Duisburg für sichtbar saubere Flächen
            </h1>

            <p className="mt-6 max-w-2xl text-lg font-medium leading-relaxed text-white/80 sm:text-xl">
              Professionelle Grundreinigung für gewerbliche Nutzflächen, robuste Böden, Sozialbereiche und Objekte mit industriellem Umfeld. Wir bringen Böden,
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="space-y-5 text-lg leading-relaxed text-gray-700">
            <p>Duisburg stellt besondere Anforderungen an Grundreinigung: Viele Flächen sind stark genutzt, teilweise gewerblich geprägt und müssen gleichzeitig schnell wieder einsatzbereit sein. Wir reinigen gründlich, praktisch und mit Blick auf echte Alltagstauglichkeit.</p>
            <p>Rund um Ruhrort, Hamborn oder Rheinhausen sind robuste Abläufe wichtig: Zugang, Parkmöglichkeiten, Materialtransport und Reinigungszeitfenster werden vorab mitgedacht.</p>
            <p>Für Duisburg setzen wir auf eine klare Priorisierung stark belasteter Bereiche: Böden, Laufstraßen, Sockelleisten, Türbereiche und Sanitärzonen.</p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-black uppercase sm:text-5xl">
              Dafür werden wir in Duisburg häufig angefragt
            </h2>
          </div>
      ...
      <section className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-16 sm:px-6 lg:grid-cols-3 lg:px-8 lg:py-24">
        <div className="bg-black p-8 text-white lg:col-span-1">
          ...
          <h2 className="mt-6 text-3xl font-black uppercase">Vor Ort in Duisburg</h2>
          <p className="mt-4 text-white/75">
            Einsatz in Innenstadt, Rheinhausen, Hamborn, Meiderich, Wanheimerort und Ruhrort. Weitere Stadtteile und angrenzende Orte prüfen wir
            gerne direkt mit.
          </p>
        </div>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 lg:grid-cols-[1fr_0.9fr]">
          <div>
            ...
            <p className="mt-6 text-lg leading-relaxed text-white/75">
              Eine Grundreinigung in Duisburg ist sinnvoll, wenn Böden stumpf wirken,
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
          <div>
            <h2 className="text-3xl font-black uppercase sm:text-4xl">
              Grundreinigung in Duisburg anfragen
            </h2>

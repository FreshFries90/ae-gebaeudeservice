...
export const metadata: Metadata = {
  title: "Grundreinigung in Oberhausen | AE Gebäudeservice",
  description:
    "Professionelle Grundreinigung in Oberhausen: Büros, Praxen, Treppenhäuser, Gewerbeflächen und Objekte nach Umbau oder Auszug. Jetzt Termin sichern.",
  alternates: { canonical: "/grundreinigung/oberhausen" },
};
...
const cityNeeds = ["Ladenlokale, Verkaufsflächen und Eingangsbereiche", "Büros, Praxen und Aufenthaltsräume", "Treppenhäuser und Gemeinschaftsflächen", "Flächen nach Umbau, Auszug oder längerer Nutzung"];

const faqs = [
  {
    question: "Was kostet eine Grundreinigung in Oberhausen?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Ja, bei vielen Objekten in Oberhausen sind Termine am Abend, am Wochenende oder in betriebsschwachen Zeiten sinnvoll. Wir stimmen das passend zu Ihrem Objekt ab.",
  },
  {
...
export default function GrundreinigungOberhausenPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Grundreinigung in Oberhausen",
    areaServed: "Oberhausen",
    provider: {
      "@type": "LocalBusiness",
    ...
    description:
      "Professionelle Grundreinigung für Büros, Praxen, Treppenhäuser, Gewerbeflächen und Wohnobjekte in Oberhausen.",
  };
    ...
    <main className="bg-white text-black overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-24">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="max-w-4xl text-4xl font-black uppercase leading-[0.95] tracking-tight sm:text-5xl md:text-7xl">
              Grundreinigung in Oberhausen für sichtbar saubere Flächen
            </h1>

            <p className="mt-6 max-w-2xl text-lg font-medium leading-relaxed text-white/80 sm:text-xl">
              Professionelle Grundreinigung für Ladenflächen, Büros, Wohnanlagen, Praxisräume und stark besuchte Gewerbestandorte im westlichen Ruhrgebiet. Wir bringen Böden,
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="space-y-5 text-lg leading-relaxed text-gray-700">
            <p>Oberhausen hat viele Flächen mit viel Bewegung: Einkaufsumfeld, Gewerbe, Wohnanlagen, Praxen und Büros. Eine Grundreinigung hilft, wenn Laufwege, Ecken, Sanitärbereiche oder Eingänge wieder deutlich frischer wirken sollen.</p>
            <p>In Alt-Oberhausen, Sterkrade oder der Neuen Mitte ist oft eine schnelle, sichtbare Verbesserung gefragt. Wir reinigen strukturiert und priorisieren die Bereiche mit größter Wirkung.</p>
            <p>Für Oberhausen eignet sich unsere Grundreinigung besonders für Objekte, die wieder sauber wirken sollen, ohne den Betrieb unnötig lange zu unterbrechen.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-100 px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <p className="text-sm font-black uppercase tracking-[0.25em] text-primary">
              Typische Einsätze in Oberhausen
            </p>
            <h2 className="mt-3 text-3xl font-black uppercase sm:text-5xl">
              Dafür werden wir in Oberhausen häufig angefragt
            </h2>
          </div>
      ...
      <section className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-16 sm:px-6 lg:grid-cols-3 lg:px-8 lg:py-24">
        <div className="bg-black p-8 text-white lg:col-span-1">
          ...
          <h2 className="mt-6 text-3xl font-black uppercase">Vor Ort in Oberhausen</h2>
          <p className="mt-4 text-white/75">
            Einsatz in Alt-Oberhausen, Sterkrade, Osterfeld, Alstaden, Schmachtendorf und Neue Mitte. Weitere Stadtteile und angrenzende Orte prüfen wir
            gerne direkt mit.
          </p>
        </div>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 lg:grid-cols-[1fr_0.9fr]">
          <div>
            ...
            <p className="mt-6 text-lg leading-relaxed text-white/75">
              Eine Grundreinigung in Oberhausen ist sinnvoll, wenn Böden stumpf wirken,
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
          <div>
            <h2 className="text-3xl font-black uppercase sm:text-4xl">
              Grundreinigung in Oberhausen anfragen
            </h2>

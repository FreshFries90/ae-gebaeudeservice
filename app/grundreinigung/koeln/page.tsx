...
export const metadata: Metadata = {
  title: "Grundreinigung in Köln | AE Gebäudeservice",
  description:
    "Professionelle Grundreinigung in Köln: Büros, Praxen, Treppenhäuser, Gewerbeflächen und Objekte nach Umbau oder Auszug. Jetzt Termin sichern.",
  alternates: { canonical: "/grundreinigung/koeln" },
};
...
const cityNeeds = ["Büros und Agenturflächen nach Umzug oder Renovierung", "Praxen, Studios und Ladenlokale mit stark genutzten Böden", "Treppenhäuser und Eingangsbereiche in Mehrparteienhäusern", "Sanitärbereiche, Küchenzonen und Aufenthaltsräume nach hoher Nutzung"];

const faqs = [
  {
    question: "Was kostet eine Grundreinigung in Köln?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Ja, bei vielen Objekten in Köln sind Termine am Abend, am Wochenende oder in betriebsschwachen Zeiten sinnvoll. Wir stimmen das passend zu Ihrem Objekt ab.",
  },
  {
...
export default function GrundreinigungKoelnPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Grundreinigung in Köln",
    areaServed: "Köln",
    provider: {
      "@type": "LocalBusiness",
    ...
    description:
      "Professionelle Grundreinigung für Büros, Praxen, Treppenhäuser, Gewerbeflächen und Wohnobjekte in Köln.",
  };
    ...
    <main className="bg-white text-black overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:py-24">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="max-w-4xl text-4xl font-black uppercase leading-[0.95] tracking-tight sm:text-5xl md:text-7xl">
              Grundreinigung in Köln für sichtbar saubere Flächen
            </h1>

            <p className="mt-6 max-w-2xl text-lg font-medium leading-relaxed text-white/80 sm:text-xl">
              Professionelle Grundreinigung für viel Publikumsverkehr, enge Zeitfenster und stark frequentierte Gewerbeflächen zwischen Rhein, Veedeln und Bürostandorten. Wir bringen Böden,
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="space-y-5 text-lg leading-relaxed text-gray-700">
            <p>In Köln treffen Büroflächen, Praxen, Ladenlokale, Gastronomie und Wohnobjekte oft direkt aufeinander. Genau deshalb braucht eine Grundreinigung hier nicht nur Kraft, sondern eine saubere Planung: kurze Abstimmungen, klare Prioritäten und Reinigungstermine, die zum laufenden Betrieb passen.</p>
            <p>Ob Altbau in Ehrenfeld, Praxis in Lindenthal oder Verkaufsfläche in der Innenstadt: Wir achten besonders auf Bodenränder, Laufstraßen, Griffbereiche, Sockel, Ecken und hygienisch sensible Flächen.</p>
            <p>Für Köln ist eine saubere Vor-Ort-Abstimmung besonders wichtig, weil Anfahrt, Parken, Hauszugang und Zeitfenster oft über den reibungslosen Ablauf entscheiden.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-100 px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <p className="text-sm font-black uppercase tracking-[0.25em] text-primary">
              Typische Einsätze in Köln
            </p>
            <h2 className="mt-3 text-3xl font-black uppercase sm:text-5xl">
              Dafür werden wir in Köln häufig angefragt
            </h2>
          </div>
      ...
      <section className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-16 sm:px-6 lg:grid-cols-3 lg:px-8 lg:py-24">
        <div className="bg-black p-8 text-white lg:col-span-1">
          ...
          <h2 className="mt-6 text-3xl font-black uppercase">Vor Ort in Köln</h2>
          <p className="mt-4 text-white/75">
            Einsatz in Innenstadt, Ehrenfeld, Nippes, Deutz, Rodenkirchen und Mülheim. Weitere Stadtteile und angrenzende Orte prüfen wir
            gerne direkt mit.
          </p>
        </div>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 lg:grid-cols-[1fr_0.9fr]">
          <div>
            ...
            <p className="mt-6 text-lg leading-relaxed text-white/75">
              Eine Grundreinigung in Köln ist sinnvoll, wenn Böden stumpf wirken,
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
          <div>
            <h2 className="text-3xl font-black uppercase sm:text-4xl">
              Grundreinigung in Köln anfragen
            </h2>

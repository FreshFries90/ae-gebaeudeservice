          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 items-center w-full min-w-0">
            <div className="lg:col-span-7 min-w-0">
              <div className="inline-block max-w-full break-words bg-primary text-white font-bold px-3 sm:px-4 py-1 mb-6 md:mb-8 -rotate-1 shadow-lg uppercase tracking-wider text-xs sm:text-sm">
                Für Sonderfälle und sensible Bereiche
              </div>
              ...
              <h1 className="text-4xl sm:text-5xl md:text-7xl xl:text-8xl font-black leading-[0.95] text-white mb-6 md:mb-8 tracking-tighter break-words">
                ...
                <span className="text-2xl sm:text-3xl md:text-5xl block mt-3 md:mt-4 text-gray-300 break-words">
                  PASSEND FÜR BESONDERE ANFORDERUNGEN
                </span>
              </h1>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-2xl border-l-4 border-primary pl-4 md:pl-6 py-2 break-words">
                Sonderfälle, empfindliche Materialien oder Bereiche mit
                besonderen Anforderungen brauchen mehr als Standardreinigung.
                Genau dafür ist unsere Spezialreinigung da – gründlich,
                abgestimmt und mit dem passenden Equipment.
              </p>
            ...
            <div className="lg:col-span-5 hidden lg:block min-w-0">
              <div className="relative w-full max-w-lg aspect-square mask-blob shadow-2xl bg-gray-800 mx-auto overflow-hidden">
                <Image
                  alt="Spezialreinigung für sensible und besondere Bereiche"
                  src="https://images.unsplash.com/photo-1581578017426-ec9954d9fdd8?auto=format&fit=crop&w=1200&q=80"
                  fill
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mb-12 md:mb-16">
            <h2 className="text-primary font-bold tracking-widest uppercase text-xs sm:text-sm mb-3 break-words">
              Spezialreinigung für Sonderfälle, Teppiche, Praxen und
            ...
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed break-words">
              Nicht jeder Bereich lässt sich mit einer normalen Reinigung
              sinnvoll abdecken. Manche Flächen sind empfindlich, manche
              Verschmutzungen hartnäckig und manche Umgebungen verlangen einfach
              mehr Sorgfalt. Genau dann ist eine Spezialreinigung sinnvoll:
              abgestimmt auf Material, Nutzung und den tatsächlichen Bedarf vor
              Ort.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-gray-50 border-l-8 border-primary p-6 sm:p-8 md:p-10">
              ...
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed break-words">
                Textile Oberflächen brauchen eine andere Behandlung als harte
                Böden oder Standardflächen. Verschmutzungen werden
                materialgerecht angegangen, damit das Ergebnis sauber und
                zugleich schonend bleibt.
              </p>
            </div>
            ...
            <div className="bg-primary text-white p-6 sm:p-8 md:p-10">
              ...
              <p className="text-white/80 text-base sm:text-lg leading-relaxed break-words">
                In Bereichen, in denen Sauberkeit besonders stark wahrgenommen
                wird, zählt ein ruhiger, gründlicher und sauber abgestimmter
                Ablauf. Genau darauf ist die Reinigung ausgerichtet.
              </p>
            </div>
            ...
            <div className="bg-black text-white p-6 sm:p-8 md:p-10">
              ...
              <p className="text-gray-400 text-base sm:text-lg leading-relaxed break-words">
                Hartnäckige Verschmutzungen, ungewöhnliche Anforderungen oder
                Flächen, bei denen Standardlösungen nicht funktionieren, werden
                individuell bewertet und passend gereinigt.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-start">
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 uppercase mb-6 break-words">
                Was eine gute Spezialreinigung ausmacht
              </h2>
              <div className="space-y-5 text-gray-700 text-base sm:text-lg leading-relaxed">
                <p className="break-words">
                  Spezialreinigung heißt nicht einfach nur stärker reinigen.
                  Meist geht es darum, die richtige Methode für einen bestimmten
                  Bereich zu wählen. Das kann bei empfindlichen Oberflächen,
                  textilen Materialien, medizinisch geprägten Umgebungen oder
                  ungewöhnlichen Verschmutzungen entscheidend sein.
                </p>
                <p className="break-words">
                  Genau deshalb ist bei solchen Einsätzen die Abstimmung
                  besonders wichtig. Welche Fläche ist betroffen? Wie
                  empfindlich ist das Material? Worum geht es tatsächlich:
                  optische Auffrischung, gründliche Tiefenreinigung oder ein
                  sauberer Zustand für den weiteren Betrieb?
                </p>
                <p className="break-words">
                  Uns ist wichtig, dass der Einsatz nicht unnötig kompliziert
                  wird. Wir schauen darauf, was gebraucht wird, wie es sinnvoll
                  umgesetzt werden kann und welches Ergebnis im Alltag wirklich
            ...
            <div className="bg-white p-6 sm:p-8 md:p-10 shadow-xl border-t-4 border-primary">
              ...
              <ul className="space-y-4 text-gray-700 text-base sm:text-lg">
                ...
                <li className="flex gap-3">
                  ...
                  <span className="break-words">
                    Reinigung von Praxen und sensiblen Räumen
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="material-icons-outlined text-primary shrink-0">
                  ...
                  <span className="break-words">
                    hartnäckige oder ungewöhnliche Verschmutzungen
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="material-icons-outlined text-primary shrink-0">
                  ...
                  <span className="break-words">
                    empfindliche Materialien und Oberflächen
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="material-icons-outlined text-primary shrink-0">
                  ...
                  <span className="break-words">
                    Auffrischung stark beanspruchter Bereiche
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="material-icons-outlined text-primary shrink-0">
                  ...
                  <span className="break-words">
                    individuelle Sonderreinigungen nach Situation
                  </span>
                </li>
              </ul>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-5xl">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 uppercase mb-10 break-words">
              Für wen sich Spezialreinigung besonders lohnt
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
              <div className="bg-gray-50 p-6 sm:p-8 border-l-4 border-primary">
                ...
                <p className="text-gray-700 leading-relaxed break-words">
                  In Bereichen, in denen Sauberkeit sofort auffällt und der
                  Gesamteindruck wichtig ist, lohnt sich eine besonders
                  abgestimmte Reinigung.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 sm:p-8 border-l-4 border-primary">
                ...
                <p className="text-gray-700 leading-relaxed break-words">
                  Teppiche, Polster und ähnliche Materialien brauchen eine
                  andere Herangehensweise als klassische Boden- oder
              ...
              <div className="bg-gray-50 p-6 sm:p-8 border-l-4 border-primary">
                ...
                <p className="text-gray-700 leading-relaxed break-words">
                  Wenn sich Verschmutzungen nicht mit üblichen Maßnahmen lösen
                  lassen oder besondere Anforderungen bestehen, ist eine
                  spezialisierte Reinigung oft der sinnvollere Weg.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 sm:p-8 border-l-4 border-primary">
                ...
                <p className="text-gray-700 leading-relaxed break-words">
                  Vor Übergaben, Neustarts, Besichtigungen oder wenn ein Bereich
                  wieder einen sauberen und gepflegten Zustand erreichen soll,
                  kann Spezialreinigung gezielt weiterhelfen.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-gray-900 overflow-hidden relative">
        <div className="container mx-auto px-4 text-center min-w-0">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-10 md:mb-12 break-words">
            ...
            Spezialreinigung sinnvoll ist und wie der Einsatz am besten
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-start lg:items-center min-w-0">
            <div className="text-white min-w-0">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-md italic break-words">
                ...
                direkt, ob eine Spezialreinigung für Ihren Fall sinnvoll ist und
                ...
                <div className="space-y-6 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <textarea
                      ...
                      name="message"
                      placeholder="Zum Beispiel: Teppichboden, Praxisräume, empfindliche Fläche, hartnäckige Verschmutzung, Sonderfall ..."
                    />
                  </div>

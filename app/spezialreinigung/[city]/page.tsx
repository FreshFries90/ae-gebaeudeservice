...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!isCitySlug(city)) {
    return {
      ...
      description:
        "Professionelle Spezialreinigung für besondere Verschmutzungen, sensible Bereiche und anspruchsvolle Reinigungsaufgaben. Gründlich, zuverlässig und schnell einsatzbereit. Jetzt anrufen.",
    };
  }
  ...
  return {
    title: `Spezialreinigung in ${cityName} | AE Gebäudeservice`,
    description: `Professionelle Spezialreinigung in ${cityName} für besondere Verschmutzungen, sensible Bereiche und anspruchsvolle Reinigungsaufgaben. Gründlich, zuverlässig und schnell einsatzbereit. Jetzt anrufen.`,
    alternates: {
      canonical: `/spezialreinigung/${city}`,
    },
  };
}

export default async function SpezialreinigungCityPage({ params }: Props) {
  const { city } = await params;
  ...
  return (
    <>
      <a
        ...
        href={`tel:${PHONE}`}
        aria-label={`Jetzt Spezialreinigung in ${cityName} anrufen`}
      >
      ...
      <section className="relative overflow-hidden bg-background-dark text-white">
        <div className="absolute inset-0">
          <Image
            ...
            alt={`Professionelle Spezialreinigung in ${cityName}`}
            fill
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 py-20 md:py-28 lg:py-36">
          <div className="max-w-4xl">
            <div className="inline-block bg-primary text-white font-bold px-4 py-2 mb-6 -rotate-1 shadow-lg uppercase tracking-wider text-xs sm:text-sm">
              Anspruchsvolle Reinigungslösungen in {cityName}
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-black leading-[0.95] tracking-tighter uppercase mb-6">
              ...
              <span className="block text-primary italic mt-2">
                in {cityName} gründlich, gezielt, zuverlässig
              </span>
            </h1>
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-3xl border-l-4 border-primary pl-4 md:pl-6 py-2 mb-8 md:mb-10">
              AE Gebäudeservice übernimmt die Spezialreinigung in {cityName}
              überall dort, wo normale Reinigung nicht ausreicht. Für besondere
              Verschmutzungen, sensible Bereiche und Reinigungsaufgaben mit
              erhöhtem Anspruch an Gründlichkeit und Sorgfalt.
            </p>
      ...
      <section className="py-16 md:py-24 bg-background-light">
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div className="relative min-h-[320px] md:min-h-[500px] overflow-hidden shadow-2xl">
            <Image
              src="/images/spezialreinigung-detail.jpg"
              alt={`Spezialreinigung in ${cityName}`}
              fill
          ...
          <div>
            <h2 className="text-primary font-bold tracking-widest uppercase text-sm mb-3">
              Spezialreinigung mit System in {cityName}
            </h2>
            <h3 className="text-4xl md:text-6xl font-black uppercase tracking-tight text-gray-900 mb-6">
              Wenn Standardreinigung nicht mehr reicht
            </h3>

            <div className="space-y-5 text-lg text-text-muted leading-relaxed">
              <p>
                Manche Verschmutzungen, Bereiche oder Anforderungen lassen sich
                nicht mit einer normalen Reinigung lösen. Genau dann ist eine
                professionelle Spezialreinigung in {cityName} sinnvoll. Sie
                kommt überall dort zum Einsatz, wo besondere Sorgfalt,
                intensivere Verfahren oder ein gezielter Reinigungsansatz
                notwendig sind.
              </p>

              <p>
                AE Gebäudeservice übernimmt in {cityName} Spezialreinigungen für
                anspruchsvolle Flächen, sensible Bereiche und besondere
                Reinigungsaufgaben. Dabei achten wir auf eine saubere
                Ausführung, klare Abstimmung und ein Ergebnis, das sichtbar
                überzeugt.
              </p>

              <p>
                Besonders wichtig ist dabei eine einfache und direkte
                Kommunikation: kurz anrufen, Bedarf schildern und direkt klären,
                welche Reinigung sinnvoll ist. Wer eine Spezialreinigung in{" "}
                {cityName} sucht, will eine belastbare Lösung ohne unnötige
                Umwege.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-lg text-text-muted leading-relaxed">
              Ob sensible Bereiche, starke Verschmutzungen oder besondere
              Reinigungsanforderungen: Wir passen die Spezialreinigung in{" "}
              {cityName} an Objekt, Zustand und Einsatzbedarf an.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: "science",
                title: "Besondere Verschmutzungen",
                text: "Gezielte Reinigung bei anspruchsvollen oder ungewöhnlichen Verschmutzungen, bei denen Standardabläufe nicht ausreichen.",
              },
              {
                icon: "health_and_safety",
                title: "Sensible Bereiche",
                text: "Sorgfältige Reinigung von Bereichen mit erhöhtem Anspruch an Hygiene, Sauberkeit und kontrollierte Ausführung.",
              },
              {
                icon: "construction",
                title: "Sonderaufgaben",
                text: "Reinigung spezieller Flächen, Bereiche oder Nutzungssituationen mit individuellem Reinigungsbedarf.",
              },
              {
                icon: "apartment",
                title: "Objekt & Gewerbe",
                text: "Für gewerblich genutzte Flächen, Objektbereiche, technische Zonen und stark beanspruchte Umfelder.",
              },
              {
                icon: "checklist",
                title: "Gezielte Maßnahmen",
                text: "Reinigung nach konkretem Bedarf statt Standardprogramm mit Fokus auf das, was vor Ort wirklich nötig ist.",
              },
              {
                icon: "event_repeat",
                title: "Einmalig oder nach Bedarf",
                text: "Einzeleinsätze, Sondertermine oder abgestimmte Reinigungen passend zum tatsächlichen Einsatzfall.",
              },
            ].map((item) => (
              <div
                key={item.title}
        ...
        <div className="container mx-auto px-4 md:px-6 flex flex-col lg:flex-row gap-6 items-center justify-between">
          <div>
            <h2 className="text-3xl md:text-5xl font-black uppercase italic text-white leading-none">
              Spezialreinigung in {cityName} direkt anfragen
            </h2>
      ...
      <section className="py-16 md:py-24 bg-background-light">
        <div className="container mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h3 className="text-4xl md:text-6xl font-black uppercase tracking-tight text-gray-900 mb-6">
              Zuverlässige Lösungen für besondere Reinigungsfälle
            </h3>

            <div className="space-y-5 text-lg text-text-muted leading-relaxed">
              <p>
                Wer eine Spezialreinigung in {cityName} beauftragt, sucht keine
                Standardlösung, sondern einen Dienstleister, der auch bei
                besonderen Anforderungen sauber, strukturiert und zuverlässig
                arbeitet. Genau darauf legen wir Wert.
              </p>

              <p>
                Viele suchen keinen Anbieter, der alles unnötig kompliziert
                macht, sondern einen Partner, der erreichbar ist, mitdenkt und
                den Einsatz sinnvoll abstimmt. Genau das ist der Anspruch von AE
                Gebäudeservice in {cityName}.
              </p>

              <p>
                Der schnellste Weg geht telefonisch: kurz anrufen, Bedarf
                schildern und direkt abstimmen, wann die Spezialreinigung
          ...
          <div className="relative min-h-[320px] md:min-h-[500px] overflow-hidden shadow-2xl">
            <Image
              src="/images/sonderreinigung.jpg"
              alt={`Saubere Fläche nach professioneller Spezialreinigung in ${cityName}`}
              fill
              className="object-cover"
            />
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20 items-start lg:items-center min-w-0">
            <div className="text-white min-w-0">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-8 md:mb-12 max-w-md italic break-words">
                ...
                direkt, was für deinen Einsatz in {cityName} sinnvoll ist und
                wie die Reinigung schnell umgesetzt werden kann.
              </p>
      ...
      <section className="py-16 md:py-24 bg-black text-white">
        <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl">
          <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tight mb-6">
            Spezialreinigung in {cityName} anfragen
          </h2>
          <p className="text-lg md:text-2xl text-gray-300 leading-relaxed mb-10">
            Du suchst in {cityName} einen zuverlässigen Partner für
            Spezialreinigung, Sonderreinigungen oder die Reinigung besonderer
            Bereiche mit erhöhtem Anspruch? Dann ruf jetzt an und besprich
            deinen Einsatz direkt mit uns. So kommst du ohne Umwege schnell zu
            einer sauberen und passenden Lösung.
          </p>
